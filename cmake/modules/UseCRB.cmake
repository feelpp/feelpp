...
" )
  ...
  foreach( wrapper pfem scm crb )
    ...
    if ( EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/applications/crb/templates/ )
      configure_file(${CMAKE_CURRENT_SOURCE_DIR}/applications/crb/templates/ot_python_command_wrapper.cpp ${pycpp})
      configure_file(${CMAKE_CURRENT_SOURCE_DIR}/applications/crb/templates/octave_wrapper.cpp ${octcpp})
