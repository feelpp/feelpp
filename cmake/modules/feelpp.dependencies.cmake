...
if ( FEELPP_ENABLE_TBB )
  FIND_PACKAGE(TBB)
  IF ( TBB_FOUND )
    SET(FEELPP_DEPS_INCLUDE_DIR ${TBB_INCLUDE_DIR} )
...
IF ( MPI_FOUND )
  ...
  SET(FEELPP_DEPS_INCLUDE_DIR ${MPI_INCLUDE_PATH} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( FEELPP_ENABLE_MKL )
  ...
  if ( MKL_FOUND )
    ...
    SET(FEELPP_DEPS_INCLUDE_DIR ${MKL_INCLUDE_DIRS} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( FEELPP_ENABLE_HDF5 )
  ...
  if( HDF5_FOUND ) 
    if( HDF5_IS_PARALLEL )
        ...
        SET(FEELPP_DEPS_INCLUDE_DIR ${HDF5_INCLUDE_DIRS} ${FEELPP_DEPS_INCLUDE_DIR})
...
if (XDMF_FOUND)
    SET(FEELPP_DEPS_INCLUDE_DIR ${XDMF_INCLUDE_DIRS} ${FEELPP_DEPS_INCLUDE_DIR})
...
SET(FEELPP_DEPS_INCLUDE_DIR ${Boost_INCLUDE_DIR} ${BOOST_INCLUDE_PATH} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/feel AND EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/contrib )
  ...
  find_library(FEELPP_GINAC_LIBRARY feelpp_ginac HINTS contrib/ginac)

  SET(FEELPP_DEPS_INCLUDE_DIR ${CLN_INCLUDE_DIR} ${FEELPP_SOURCE_DIR}/contrib/ginac/ ${FEELPP_BUILD_DIR}/contrib/ginac/ ${FEELPP_SOURCE_DIR}/contrib/ginac/ginac ${FEELPP_BUILD_DIR}/contrib/ginac/ginac ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( FEELPP_ENABLE_HARTS )
  ...
  if( HARTS_FOUND )
    ...
    SET(FEELPP_DEPS_INCLUDE_DIR ${HARTS_INCLUDES} ${FEELPP_DEPS_INCLUDE_DIR})
...
SET(FEELPP_DEPS_INCLUDE_DIR ${EIGEN3_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( ANN_FOUND )
  ...
  SET(FEELPP_DEPS_INCLUDE_DIR ${ANN_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( GLPK_FOUND )
  ...
  SET(FEELPP_DEPS_INCLUDE_DIR ${GLPK_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( FEELPP_ENABLE_GOOGLEPERFTOOLS )
  ...
  if ( GOOGLE_PERFTOOLS_FOUND )
    ...
    SET(FEELPP_DEPS_INCLUDE_DIR ${GOOGLE_PERFTOOLS_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
SET(FEELPP_DEPS_INCLUDE_DIR ${GFLAGS_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
SET(FEELPP_DEPS_INCLUDE_DIR ${GLOG_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( LIBXML2_FOUND )
    ...
    SET(FEELPP_DEPS_INCLUDE_DIR ${LIBXML2_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( PYTHONLIBS_FOUND )
  ...
  SET(FEELPP_DEPS_INCLUDE_DIR ${PYTHON_INCLUDE_DIRS} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( PETSC_FOUND )
  ...
  SET(FEELPP_DEPS_INCLUDE_DIR ${PETSC_INCLUDE_DIR} ${PETSC_INCLUDE_CONF} ${FEELPP_DEPS_INCLUDE_DIR})
  SET(FEELPP_ENABLED_OPTIONS "${FEELPP_ENABLED_OPTIONS} PETSc" )
...
if (FEELPP_ENABLE_SLEPC)
  ...
  if ( SLEPC_FOUND )
    ...
    SET(FEELPP_DEPS_INCLUDE_DIR ${SLEPC_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
if (FEELPP_ENABLE_TRILINOS)
  ...
  if ( TRILINOS_FOUND )
    SET(FEELPP_DEPS_INCLUDE_DIR ${TRILINOS_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
IF ( FEELPP_ENABLE_OPENTURNS )
  ...
  if ( OPENTURNS_FOUND )
    ...
    SET(FEELPP_DEPS_INCLUDE_DIR ${OpenTURNS_INCLUDE_DIRS} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( FEELPP_ENABLE_VTK )
    ...
    if ( FEELPP_ENABLE_VTK_INSITU )
        ...
        SET(FEELPP_DEPS_INCLUDE_DIR ${ParaView_INCLUDE_DIRS} ${FEELPP_DEPS_INCLUDE_DIR})
        SET(FEELPP_DEPS_INCLUDE_DIR ${VTK_INCLUDE_DIRS} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( FEELPP_ENABLE_OCTAVE )
  ...
  if ( OCTAVE_FOUND )
    ...
    SET(FEELPP_DEPS_INCLUDE_DIR ${OCTINCLUDEDIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( GMSH_FOUND )
  ...
  SET(FEELPP_DEPS_INCLUDE_DIR ${GMSH_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
...
if ( NOT EXISTS ${CMAKE_SOURCE_DIR}/feel OR NOT EXISTS ${CMAKE_SOURCE_DIR}/contrib )
  ...
  find_package(CLN)
  if ( CLN_FOUND )
    SET(FEELPP_DEPS_INCLUDE_DIR ${CLN_INCLUDE_DIR} ${FEELPP_DEPS_INCLUDE_DIR})
