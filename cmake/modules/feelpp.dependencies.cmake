...
if ( GMSH_FOUND )
  ...
  if ( GL2PS_LIBRARY )
    if ( GL_LIBRARY AND FEELPP_ENABLE_OPENGL )
      SET(FEELPP_LIBRARIES ${FEELPP_LIBRARIES} ${GMSH_LIBRARIES} ${GL2PS_LIBRARY} ${GL_LIBRARY} )
    else()
      SET(FEELPP_LIBRARIES ${FEELPP_LIBRARIES} ${GMSH_LIBRARIES} ${GL2PS_LIBRARY} )
    endif()
  else()
    SET(FEELPP_LIBRARIES ${FEELPP_LIBRARIES} ${GMSH_LIBRARIES} )
  endif()
