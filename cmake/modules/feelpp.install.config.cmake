...
if ( EXISTS ${CMAKE_CURRENT_BINARY_DIR}/cmake/modules/Feel++Config.cmake )
  ...
  endforeach()
  list(APPEND FEELPP_DEPS_INCLUDE_DIR_WITH_SPACE  " ${FEELPP_INSTALL_DIR}/include/feelpp/eigen/ ")
  list(APPEND FEELPP_DEPS_INCLUDE_DIR_WITH_SPACE  " ${FEELPP_INSTALL_DIR}/include/feelpp/eigen/unsupported/ ")
  if ( FEELPP_HAS_GINAC )
    list(APPEND FEELPP_DEPS_INCLUDE_DIR_WITH_SPACE  " ${FEELPP_INSTALL_DIR}/include/feelpp/ginac/ ")
  endif()
  if ( FEELPP_HAS_METIS )
    list(APPEND FEELPP_DEPS_INCLUDE_DIR_WITH_SPACE  " ${FEELPP_INSTALL_DIR}/include/feelpp/metis/ ")
  endif()
  if ( FEELPP_HAS_NLOPT )
    list(APPEND FEELPP_DEPS_INCLUDE_DIR_WITH_SPACE  " ${FEELPP_INSTALL_DIR}/include/feelpp/nlopt/ ")
  endif()
 if ( FEELPP_HAS_IPOPT )
    list(APPEND FEELPP_DEPS_INCLUDE_DIR_WITH_SPACE  " ${FEELPP_INSTALL_DIR}/include/feelpp/ipopt/ ")
  endif()
