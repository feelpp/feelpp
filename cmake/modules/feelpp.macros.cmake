...
macro ( om_add_model )
  ...
  set( OMWRAPPER_MAKEFILE ${OMWRAPPER_NAME}.makefile )
   ...
   if( NOT EXISTS ${OMWRAPPER_LIBDIR}/${OMWRAPPER_NAME}.c )
     execute_process( COMMAND ${OMC_COMPILER} -s ${OMWRAPPER_SRCS_FULLPATH}  WORKING_DIRECTORY ${OMWRAPPER_LIBDIR} OUTPUT_QUIET )
     message( "OMCompiler : generation of model ${OMWRAPPER_NAME}")
