...
if (NOT FEELPP_C)
  MESSAGE(WARNING "NO C COMPILER PROVIDED - USING DEFAULT ONE")
  set(FEELPP_CXX "gcc")
endif(NOT FEELPP_C)
...
set(CMAKE_OPTIONS "${CMAKE_OPTIONS} -DCMAKE_CXX_COMPILER:STRING=${FEELPP_CXX} -DCMAKE_C_COMPILER:STRING=${FEELPP_C}")
set(CMAKE_OPTIONS "${CMAKE_OPTIONS} -DVTK_LEGACY_REMOVE:BOOL=ON")
if (FEELPP_STD_CPP)
  set(CMAKE_OPTIONS "${CMAKE_OPTIONS} -DFEELPP_STD_CPP=${FEELPP_STD_CPP}")
endif()
if(DEFINED ${STDLIB_CPP})
  SET(CMAKE_OPTIONS "${CMAKE_OPTIONS} -DFEELPP_STDLIB_CPP=${STDLIB_CPP}")
endif()
...
if(DEFINED DEFAULT_TEST_TIMEOUT )
  SET(CMAKE_OPTIONS "${CMAKE_OPTIONS} -DFEELPP_DEFAULT_TEST_TIMEOUT=${DEFAULT_TEST_TIMEOUT}")
endif()
...
if(DEFINED ENABLE_RESEARCH_FEELPP-BOOK)
  SET(CMAKE_OPTIONS "${CMAKE_OPTIONS} -DFEELPP_ENABLE_RESEARCH_FEELPP-BOOK=${ENABLE_RESEARCH_FEELPP-BOOK}")
endif()
