...
##$COMMON-gcc-4.5.2-mpi,FEEL_CXX=g++-4.5,FEEL_EXPLICIT_VECTORIZATION=SSE2,FEEL_ENABLE_MPI_MODE=ON
$COMMON-gcc-4.6.2,FEEL_CXX=g++-4.6,FEEL_EXPLICIT_VECTORIZATION=SSE2
$COMMON-gcc-4.6.2-mpi,FEEL_CXX=g++-4.6,FEEL_EXPLICIT_VECTORIZATION=SSE2,FEEL_ENABLE_MPI_MODE=ON
