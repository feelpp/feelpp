cl__1 = 0.0008;
cl__2 = 0.00017;
Point(5) = {0.006, 0, 0.18, 0.0008};
Point(6) = {0, 0, 0.18, 0.0008};
Point(7) = {0.006, 0, 0, 0.0008};
Point(8) = {0, 0, 0, 0.00017};
Point(10) = {0, 0, 0, 0.00017};
Point(27) = {0.006, 0, 0.008, 0.0008};
Point(28) = {0, 0, 0.008, 0.0008};
Point(29) = {0.006, 0, 0.016, 0.0008};
Point(30) = {0, 0, 0.016, 0.0008};
Point(31) = {0.006, 0, 0.024, 0.0008};
Point(32) = {0, 0, 0.024, 0.0008};
Point(33) = {0.006, 0, 0.032, 0.0008};
Point(34) = {0, 0, 0.032, 0.0008};
Point(35) = {0.006, 0, 0.06, 0.0008};
Point(36) = {0, 0, 0.06, 0.0008};
Point(37) = {0.006, 0, 0.08, 0.0008};
Point(38) = {0, 0, 0.08, 0.0008};
Line(1) = {8, 7};
Line(2) = {7, 27};
Line(3) = {27, 29};
Line(4) = {29, 31};
