...
Physical Volume(1) = {1}; // Tore
Physical Volume(2) = {2}; // Air
Physical Volume(3) = {3}; // Infini

Physical Surface(10) = {6};   // V0
Physical Surface(11) = {40};  // V1
Physical Surface(12) = {39};  // Rint
Physical Surface(13) = {31};  // Rext
Physical Surface(14) = {27};  // Hchannel Bas
Physical Surface(15) = {35};  // Hchannel Haut

Physical Surface(20) = {12, 18};  // Sym
Physical Surface(21) = {74, 96};  // Sym

Physical Surface(30) = {85, 88};  // Inf
