...
Volume(1) = {1};
Physical Surface("wall") = {193, 197, 201, 165, 173, 169, 189, 177, 185, 181, 249, 237, 245, 233, 229, 221, 217, 213, 205, 209, 241, 225, 297, 261, 253, 265, 277, 269, 273, 281, 293, 285, 321, 305, 301, 317, 309, 357, 365, 361, 325, 369, 341, 333, 349, 353, 345, 337, 329, 409, 413, 405, 417, 373, 389, 381, 377, 401, 397, 393, 385, 313, 289,257};
Physical Surface("inlet") = {153};
Physical Surface("outlet") = {161};
Physical Surface("wall") = {149, 157};
