...
setup(
    ...
    packages=['pyfeelpp',
              ...
              'pyfeelpp.toolboxes.advection','pyfeelpp.toolboxes.fluid','pyfeelpp.toolboxes.solid',
...
#    ext_modules=[Extension('pyfeelpp',['pyfeelpp/python.cpp'],include_dirs=@FEELPP_INCLUDE_DIRS@,libraries=@FEELPP_LIBRARIES@)
    ext_modules=[CMakeExtension('_pyfeelpp','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp'),
                 ...
                 CMakeExtension('_modelcore','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp/toolboxes/modelcore'),
                 CMakeExtension('_modelmesh','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp/toolboxes/modelmesh'),
                 CMakeExtension('_advection','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp/toolboxes/advection'),
                 ...
                 CMakeExtension('_maxwell','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp/toolboxes/maxwell'),
                 CMakeExtension('_hdg','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp/toolboxes/hdg'),
                 CMakeExtension('_levelset','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp/toolboxes/levelset'),
                 CMakeExtension('_multifluid','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp/toolboxes/multifluid'),
                 CMakeExtension('_thermoelectric','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp/toolboxes/thermoelectric'),
                 CMakeExtension('_fsi','@CMAKE_CURRENT_SOURCE_DIR@/pyfeelpp/toolboxes/fsi'),
