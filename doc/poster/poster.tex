...
\newcommand{\inputsnapshot}[1]{
  ...
  \begin{frame}[containsverbatim]{} 
    ...
    \end{block}
    \vfill
%     \begin{block}{Feel++: Example of a DSEL -- Navier-Stokes}
%     \begin{itemize}
%     \item Feel++: C++ library C++ for partial differential solves developed at U. Grenoble(LJK)
...
%   \end{block}
%   \vfill
% \begin{block}{Feel++: Example of DSEL -- Stabilization}
%   \begin{itemize}
  ...
  \begin{block}{Applications: Navier-Stokes incompressible Multi-Fluid}
    ...
    \begin{columns}[t]
      \begin{column}{.45\textwidth}
        \begin{figure}
      \centering
      \subfigure[$t=2$]{\includegraphics[width=.4\linewidth]{duebolle2-2}}\goodgap
      \subfigure[$t=20$]{\includegraphics[width=.4\linewidth]{duebolle2-20}}\\
      \subfigure[$t=30$]{\includegraphics[width=.4\linewidth]{duebolle2-30}}\goodgap
      \subfigure[$t=50$]{\includegraphics[width=.4\linewidth]{duebolle2-50}}\\
      \subfigure[$t=70$]{\includegraphics[width=.4\linewidth]{duebolle2-70}}\goodgap
      \subfigure[$t=90$]{\includegraphics[width=.4\linewidth]{duebolle2-90}}
