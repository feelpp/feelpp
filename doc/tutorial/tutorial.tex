...
\chapter{Creating applications}
\label{sec:creat-appl}


\marginpar{\lstinline!myapp.cpp!}

\section{Application and Options}
\label{sec:options}
...
\section{Application, Logging and Archiving}
...
\section{PETSc and Trilinos Application}
...
\section{Iterating over the entities of a mesh}
...
\section{Defining function spaces and functions}
...
\section{Using functions spaces and functions}
...
\section{Choosing a linear algebra backend}
...
\section{Defining and using matrices and vectors}
...
\section{Standard formulation: the Laplacian case}
...
\subsubsection{Strong Dirichlet conditions}
...
\subsubsection{Weak Dirichlet conditions}
...
\section{Mixed formulation: the Stokes case}
