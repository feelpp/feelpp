...
[source,cpp,numbered]
----
{% include "/doc/book/Tutorial/code/02-environment.cpp" %}
----
...
[source,c++,numbered]
----
{% include "/doc/book/Tutorial/code/02-environment.cfg" %}
----

[include:2-3](/doc/book/Tutorial/code/02-environment.cfg)
