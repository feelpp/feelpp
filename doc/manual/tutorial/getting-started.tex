...
N.B You can modify the domain size in order to obtain a clearer figure by adding diffrent values to _xmin   _ymin  _xmax and _ymax  in the definition of the mesh in \lstinline!laplacian.cpp!
