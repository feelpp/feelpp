...
\begin{remark}
 ...
 \begin{figure}[!h]%[htbp]
  \centering
  \subfigure[domain 1]{\includegraphics[width=.43\linewidth]{pngs/laplacianFig/laplacian_1.png}}
  \subfigure[domain 2]{\includegraphics[width=.43\linewidth]{pngs/laplacianFig/laplacian_2.png}}\\
  \subfigure[domain 3]{\includegraphics[width=.43\linewidth]{pngs/laplacianFig/laplacian_3.png}}
  \subfigure[partition colored with pid]{\includegraphics[width=.43\linewidth]{pngs/laplacianFig/laplacian_Pid.png}}
