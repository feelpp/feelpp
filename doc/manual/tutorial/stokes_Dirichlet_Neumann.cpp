...
*/
/**
   \filestokes_Dirichlet_Neumann.cpp
...
makeOptions()
{
    Feel::po::options_description stokesDirichletNeumannOptions( "Stokes_Dirichlet_Neumann options" );
    stokesDirichletNeumannOptions.add_options()
    ...
    ;
    return stokesDirichletNeumannOptions.add( Feel::feel_options() ) ;
}
...
makeAbout()
{
    Feel::AboutData about( "stokes_Dirichlet_Neumann" ,
 ...
 *
 */
class Stokes_Dirichlet_Neumann
    :
public Application
{
...
Stokes_Dirichlet_Neumann::init()
{
    ...
    //                      _filename="/home/u2/tarabay/feel/geo/aorta_centerlines.msh",
    ...
    // //mesh->addMarkerName( "Inlet", 19, 2 );
    // //mesh->addMarkerName( "Outlet", 27, 2 );
     mesh->addMarkerName( "inlet", 1, 1 );
     mesh->addMarkerName( "outlets", 3, 1 );
    ...
    C.setMarker(_type="surface",_name="outlets",_marker2=true);
    C.setMarker(_type="surface",_name="outerWall",_marker3=true);
...
template<typename ExprUExact, typename ExprPExact>
void
Stokes_Dirichlet_Neumann::exportResults( ExprUExact u_exact, ExprPExact p_exact, element_type& U, element_type& V )
{
    auto u = U.element<0>();
    auto p = U.element<1>();
