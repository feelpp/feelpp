...
\include{tutorial/building}
\include{tutorial/getting-started}
\include{tutorial/feel}

\part{Learning by Examples}
\label{part:learning-examples}

\include{examples/nonlinear}
\include{examples/thermalfin}
\include{examples/natural-convection-2d}
\include{examples/maxwell}
