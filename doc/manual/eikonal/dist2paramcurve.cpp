...
int main( int argc, char** argv )
{
  ...
  *predefEllipse = fm->march( predefEllipse, true );
  ...
  // auto Ellipse_resigned = Xh1->elementPtr();
  // *Ellipse_resigned = vf::project( Xh1, elements(mesh), vf::abs( idv(predefEllipse) ) );


  // node_type newnode(2);
  // newnode[0] = 0.5;
  // newnode[1] = 0.5;
  // std::vector< node_type > nodeInList;
  // nodeInList.push_back( newnode );
  // //  disttocurve->setInnerRegion( Ellipse_resigned, nodeInList );
