...
makeOptions()
{
    ...
    testhdivoptions.add_options()
        ...
        ("check_errors", po::value<bool>()->default_value( false ), "Check flux and potential errors")
        ("p_exact", po::value<std::string>()->default_value( "1" ), "potential")
        ;
