...
In order to \feel and \cmake work properly, you have to install different compilers :
\begin{itemize}
\item Gcc \\
...
% Go in the same folder in which you have done the checkout and type the following
% commands :
