...
bind_forms( py::module &m, std::string const& space_str )
{
    ...
    py::class_<form2_type<SpaceType, SpaceType>>( m, fmt::format( "form2_{}", space_str ).c_str() )
        ...
        .def( "__call__", []( form2_type<SpaceType, SpaceType> const& a, element_t const& u, element_t const& v )
              { return a( u, v ); } )
        .def( "__call__", []( form2_type<SpaceType, SpaceType> const& a, element_t const& u )
              { return a( u ); } )
        .def( "coercivity", []( form2_type<SpaceType, SpaceType> const& a, form2_type<SpaceType, SpaceType> const& b, nl::json const& options )
              { 
        ...
        .def( "continuity", []( form2_type<SpaceType, SpaceType> const& a, form2_type<SpaceType, SpaceType> const& b, nl::json const& options )
              { 
