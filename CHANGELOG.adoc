...
[[v0.105.0-2018-06-xx]]
== v0.105.0 (unreleased)
// https://github.com/feelpp/feelpp/tree/v0.105.0[v0.105.0] (2018-06-xx)

https://github.com/feelpp/feelpp/compare/v0.104.0...v0.105.0[Full Changelog]

=== Features

* [**feel/**] remote data handling via github and girder, support testcase by directory, see  issues #1116 #1121 and PR #1164. See
* [**feel/**] dynamic quadrature, see issue #571 and PR #747, see link:http://docs.feelpp.org/dev/0.105/reference/Integrals/README/[documentation]
* [**toolbox/**] continued effort on toolboxes refactoring, see link:https://github.com/feelpp/feelpp/pull/1165[PR]
