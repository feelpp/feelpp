...
[[v0.104.1-2018-05-xx]]
== v0.104.1 (unreleased) // https://github.com/feelpp/feelpp/tree/v0.104.1[v0.104.1] (2018-05-xx)

https://github.com/feelpp/feelpp/compare/v0.104.0...v0.104.1[Full Changelog]

* Add cantilever example for quickstart elasticity code in 2D
* Fix newmark restart if a frequency is used
