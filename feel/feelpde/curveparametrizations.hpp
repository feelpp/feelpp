...
namespace Feel
{
  ...
  std::tuple< std::function<double(double)>, std::function<double(double)>, double, double >
  circleParametrization( double r, double x0, double y0 )
  {
  ...
  std::tuple< std::function<double(double)>, std::function<double(double)>, double, double >
  ellipseParametrization( double a_ell, double b_ell, double x0, double y0 )
  {
  ...
  epitrochoidParametrization( double a_epi, double b_epi, double scaleFactor, double x0, double y0 )
  {
  ...
  std::tuple< std::function<double(double)>, std::function<double(double)>, double, double >
  crescentParametrization( double R1, double R2, double H, double l, double x0, double y0)
  {
