          ...
          elt != this->endElement(); ++elt )
    {
        ...
        for ( size_type j = 0;j < size_type(element_type::numVertices);j++ )
        {
            ...
            else
            {
                ...
                FEEL_ASSERT( __fit != this->endFace() )( e.first )( j )( i1 ).error( "invalid face iterator" );

                face_type __f = *__fit;

                FEEL_ASSERT( __f.id() == __fit->id() )
                    ( __f.id() )
                ...
                {
                    FEEL_ASSERT( __f.isConnectedTo0() )( __element_id )( j ).error( "invalid data : ad_first not filled" );
                    ...
                    FEEL_ASSERT( __element_id != __f.ad_first() )
...
#endif
                    FEEL_ASSERT( __f.isConnectedTo0() && __f.isConnectedTo1() )
                    ...
                    FEEL_ASSERT( elt1 != this->endElement() )( __f.ad_first() ).error( "invalid element" );
