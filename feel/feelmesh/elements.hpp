...
public:
    ...
    WorldComm const& worldCommElements() const { return _M_worldCommElements; }
    ...
    void setWorldCommElements(WorldComm const& _worldComm) { _M_worldCommElements = _worldComm; }
