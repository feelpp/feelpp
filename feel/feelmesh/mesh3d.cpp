                    ...
                    if ( e.second )
                        {
                            ...
                            FEEL_ASSERT( __fit != this->endFace() )( e.first )( iv->id() ).error( "invalid face iterator" );
    ...
    for ( ;iv != en; ++iv )
        {
            ...
            FEEL_ASSERT( counter >= 1 )( __element.id() )( __element.nNeighbors() )( counter ).error( "invalid neighboring data" );
