...
public:
     ...
     */
    virtual sparse_matrix_ptrtype newMatrix() const { return M_model->newMatrix(); }

    /**
     * \brief Returns the matrix associated with the \f$H_1\f$ inner product
     */
    sparse_matrix_ptrtype const& innerProduct() const { return M_B; }

    /**
     * \brief Returns the matrix associated with the \f$H_1\f$ inner product
     */
    sparse_matrix_ptrtype const& h1() const { return M_B; }

    //!  Returns the function space
    functionspace_ptrtype  functionSpace() const { return M_model->functionSpace(); }
    ...
    size_type Ql( int l ) const { return M_model->Ql( l ); }

    //! return the parameter space
    parameterspace_ptrtype parameterSpace() const { return M_model->parameterSpace(); }
     ...
     */
    void setMeshSize( double s ) { M_model->setMeshSize( s ); }
     ...
     */
    theta_vector_type const& thetaAq() const { return M_model->thetaAq(); }
     ...
     */
    value_type thetaAq( int q ) const { return M_model->thetaAq( q ); }
     ...
     * \brief Returns the vector coefficients
     */
    std::vector<theta_vector_type> const& thetaL() const { return M_model->thetaL(); }

    /**
     * \brief Returns the value of the \f$L_q\f$ coefficient at \f$\mu\f$
     */
    value_type thetaL( int l, int q ) const { return M_model->thetaL( l, q ); }
     ...
     */
    vector_ptrtype  Fq( uint16_type l, uint16_type q ) const { return M_Fq[l][q]; }
