                     ...
                     public boost::enable_shared_from_this<ModelCrbBase<ParameterDefinition, FunctionSpaceDefinition, _Options, EimDefinition>>
{
  ...
  public:
    ...
    typedef typename mpl::if_<mpl::bool_<is_time_dependent>,
                              ...
                              boost::tuple<
                                  sparse_matrix_ptrtype, std::vector<vector_ptrtype>>>::type monolithic_type;

    typedef typename mpl::if_<mpl::bool_<is_time_dependent>,
                              boost::tuple<
                                  std::map<int, double>, std::map<int, double>, std::vector<std::map<int, double>>>,
                              boost::tuple<
                                  std::map<int, double>, std::vector<std::map<int, double>>>>::type eim_interpolation_error_type;
    ...
    typedef typename mpl::if_<mpl::bool_<is_time_dependent>,
                              ...
                              boost::tuple<
                                  beta_vector_type,
                                  std::vector<beta_vector_type>>>::type betaqm_type;
    ...
    typedef typename mpl::if_<mpl::bool_<is_time_dependent>,
                              ...
                              boost::tuple<
                                  beta_vector_light_type,
                                  std::vector<beta_vector_light_type>>>::type betaq_type;
...
void ModelCrbBase<ParameterDefinition, FunctionSpaceDefinition, _Options, EimDefinition>::setFunctionSpaces( functionspace_ptrtype Vh )
{
    Xh = Vh;
