    ...
    struct ComputeIntegralsSquare
    {
        ...
        operator()( const T& t ) const
        {
            ...
            double integral = integrate( _range = elements( mesh ),
                                         _expr = trans( vf::idv( e1 ) - vf::idv( e2 ) ) * ( vf::idv( e1 ) - vf::idv( e2 ) ) )
                                  .evaluate()( 0, 0 );
...
template <typename TruthModelType>
void CRB<TruthModelType>::offlineUpdateJacobian( const vector_ptrtype& X, sparse_matrix_ptrtype& J, const parameter_type& mu )
{
    J->zero();
...
template <typename TruthModelType>
void CRB<TruthModelType>::offlineUpdateResidual( const vector_ptrtype& X, vector_ptrtype& R, const parameter_type& mu )
{
    R->zero();
    std::vector<beta_vector_type> betaRqm;
...
template <typename TruthModelType>
void CRB<TruthModelType>::loadSCMDB()
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::updateAffineDecompositionSize()
{
    if ( M_error_type == CRB_RESIDUAL || M_error_type == CRB_RESIDUAL_SCM )
    {
...
template <typename TruthModelType>
void CRB<TruthModelType>::checkInitialGuess( const element_type expansion_uN, parameter_type const& mu, vectorN_type& error ) const
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::checkInitialGuess( const element_type expansion_uN, parameter_type const& mu, vectorN_type& error, mpl::bool_<false> ) const
{
    error.resize( 1 );
    ...
    error( 0 ) = math::sqrt(
        integrate( _range = elements( mesh ),
                   _expr = vf::idv( initial_guess ) * vf::idv( expansion_uN ) * vf::idv( initial_guess ) * vf::idv( expansion_uN ) )
            .evaluate()( 0, 0 ) );
}

template <typename TruthModelType>
void CRB<TruthModelType>::checkInitialGuess( const element_type expansion_uN, parameter_type const& mu, vectorN_type& error, mpl::bool_<true> ) const
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::buildVarianceMatrixPhi( int const N )
{
    static const bool is_composite = functionspace_type::is_composite;
    return buildVarianceMatrixPhi( N, mpl::bool_<is_composite>() );
}
template <typename TruthModelType>
void CRB<TruthModelType>::buildVarianceMatrixPhi( int const N, mpl::bool_<true> )
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::buildVarianceMatrixPhi( int const N, mpl::bool_<false> )
{
    std::vector<std::string> s;
...
template <typename TruthModelType>
void CRB<TruthModelType>::buildFunctionFromRbCoefficients( int N, std::vector<vectorN_type> const& RBcoeff, wn_type const& WN, std::vector<element_ptrtype>& FEMsolutions )
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::compareResidualsForTransientProblems( int N, parameter_type const& mu, std::vector<element_type> const& Un, std::vector<element_type> const& Unold,
...
template <typename TruthModelType>
void CRB<TruthModelType>::checkResidual( parameter_type const& mu, std::vector<std::vector<double>> const& primal_residual_coeffs,
                                         std::vector<std::vector<double>> const& dual_residual_coeffs, element_type& u, element_type& udu ) const
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::check( size_type N ) const
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::computeProjectionInitialGuess( const parameter_type& mu, int N, vectorN_type& initial_guess ) const
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::updateJacobian( const map_dense_vector_type& map_X, map_dense_matrix_type& map_J, const parameter_type& mu, int N ) const
{
    //map_J.setZero( N , N );
    map_J.setZero();
    beta_vector_type betaJqm;
...
template <typename TruthModelType>
void CRB<TruthModelType>::updateResidual( const map_dense_vector_type& map_X, map_dense_vector_type& map_R, const parameter_type& mu, int N ) const
{
    map_R.setZero();
    std::vector<beta_vector_type> betaRqm;
...
template <typename TruthModelType>
void CRB<TruthModelType>::fixedPointDual( size_type N, parameter_type const& mu, std::vector<vectorN_type>& uNdu, std::vector<vectorN_type>& uNduold, std::vector<double>& output_vector, int K ) const
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::exportBasisFunctions( const export_vector_wn_type& export_vector_wn ) const
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::offlineResidual( int Ncur, int number_of_added_elements )
{
    return offlineResidual( Ncur, mpl::bool_<model_type::is_time_dependent>(), number_of_added_elements );
}

template <typename TruthModelType>
void CRB<TruthModelType>::offlineResidualEim( int Ncur, int number_of_added_elements )
{
    return offlineResidualEim( Ncur, mpl::bool_<model_type::is_time_dependent>(), number_of_added_elements );
}

template <typename TruthModelType>
void CRB<TruthModelType>::offlineResidual( int Ncur, mpl::bool_<true>, int number_of_added_elements )
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::offlineResidualEim( int Ncur, mpl::bool_<true>, int number_of_added_elements )
{
    offlineResidualEim( Ncur, mpl::bool_<false>(), number_of_added_elements );
}

template <typename TruthModelType>
void CRB<TruthModelType>::offlineResidual( int Ncur, mpl::bool_<false>, int number_of_added_elements )
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::offlineResidualV0( int Ncur, mpl::bool_<false>, int number_of_added_elements )
{
    boost::timer ti;
    int __QLhs = M_model->Qa();
    int __QRhs = M_model->Ql( 0 );
...
template <typename TruthModelType>
void CRB<TruthModelType>::offlineResidualV1( int Ncur, mpl::bool_<false>, int number_of_added_elements )
{
    boost::timer ti;
    int __QLhs = M_model->Qa();
    int __QRhs = M_model->Ql( 0 );
...
template <typename TruthModelType>
void CRB<TruthModelType>::offlineResidualEim( int Ncur, mpl::bool_<false>, int number_of_added_elements )
{
    boost::timer ti;
    int __QLhs = M_model->Qa();
    int __QRhs = M_model->Ql( 0 );
...
template <typename TruthModelType>
void CRB<TruthModelType>::printErrorsDuringRbConstruction( void )
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::printMuSelection( void )
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::printRbPicardIterations()
{
    if ( Environment::worldComm().isMasterRank() )
    {
        std::ofstream file;
...
template <typename TruthModelType>
void CRB<TruthModelType>::printOnlineRbPicardIterations( parameter_type mu ) const
{
    if ( Environment::worldComm().isMasterRank() )
    {
        std::ofstream file;
...
CRB<TruthModelType>::expansion( parameter_type const& mu, int N, int time_index )
{
    ...
    FEELPP_ASSERT( N <= M_model->rBFunctionSpace()->size() )
    ( N )( M_model->rBFunctionSpace()->size() ).error( "invalid expansion size ( N and RB size ) " );
...
CRB<TruthModelType>::expansion( vectorN_type const& u, int const N, wn_type const& WN ) const
{
    ...
    FEELPP_ASSERT( Nwn <= WN.size() )
    ( Nwn )( WN.size() ).error( "invalid expansion size ( Nwn and WN ) " );
    FEELPP_ASSERT( Nwn <= u.size() )
    ( Nwn )( WN.size() ).error( "invalid expansion size ( Nwn and u ) " );
...
template <typename TruthModelType>
void CRB<TruthModelType>::run( const double* X, unsigned long N, double* Y, unsigned long P )
{
    return run( X, N, Y, P, mpl::bool_<model_type::is_time_dependent>() );
}

template <typename TruthModelType>
void CRB<TruthModelType>::run( const double* X, unsigned long N, double* Y, unsigned long P, mpl::bool_<true> )
{
    //std::cout<<"N = "<<N<<" et P = "<<P<<std::endl;

    for ( unsigned long p = 0; p < N - 5; ++p )
        std::cout << "mu[" << p << "] = " << X[p] << std::endl;
...
//std::cout<<"M_compute_variance = "<<M_compute_variance<<std::endl;
    ...
    FEELPP_ASSERT( P == 2 )
    ( P ).warn( "invalid number of outputs" );
    auto o = lb( Nwn, mu, uN, uNdu, uNold, uNduold );
...
template <typename TruthModelType>
void CRB<TruthModelType>::run( const double* X, unsigned long N, double* Y, unsigned long P, mpl::bool_<false> )
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::projectionOnPodSpace( const element_type& u, element_ptrtype& projection, const std::string& name_of_space )
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::updateApeeBasisConstruction( int N, std::vector<parameter_type> const& new_primal_parameters, std::vector<parameter_type> const& new_dual_parameters ) const
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::updateApeeOfflineResidualComputation( int N, std::vector<parameter_type> const& new_primal_parameters, std::vector<parameter_type> const& new_dual_parameters )
{
    int index = M_primal_V.size(); // current size
    int primal_size = new_primal_parameters.size();
    int new_size = index + primal_size;
...
template <typename TruthModelType>
void CRB<TruthModelType>::assemblePrimalAndDualApeeBasisMatrices( int N ) const
{
    int Qa = M_model->Qa();
    int Qf = M_model->Ql( 0 );
    int Ql = M_model->Ql( M_output_index );
    ...
    FEELPP_ASSERT( primal_rows == primal_cols )
    ( primal_rows )( primal_cols ).error( "invalid size of matrix M_primal_T (should be a square matrix)" );

    int number_of_elements_to_add = primal_size - primal_rows;
    FEELPP_ASSERT( number_of_elements_to_add > 0 )
    ( number_of_elements_to_add )( primal_size )( primal_rows ).error( "assemblePrimalAndDualApeeBasisMatrices was called but there is no elements to add in M_primal_T " );
    ...
    FEELPP_ASSERT( dual_rows == dual_cols )
    ( dual_rows )( dual_cols ).error( "invalid size of matrix M_dual_T (should be a square matrix)" );

    number_of_elements_to_add = dual_size - dual_rows;
    FEELPP_ASSERT( number_of_elements_to_add > 0 )
    ( number_of_elements_to_add )( dual_size )( dual_rows ).error( "assemblePrimalAndDualApeeBasisMatrices was called but there is no elements to add in M_dual_T " );
...
template <typename TruthModelType>
void CRB<TruthModelType>::selectPrimalApeeParameters( int N, std::vector<parameter_type>& new_parameters )
{
    int Qa = M_model->Qa();
    int Qf = M_model->Ql( 0 );
    int primal_size = Qf * Qf + N * Qa * Qf + N * N * Qa * Qa;
...
template <typename TruthModelType>
void CRB<TruthModelType>::selectDualApeeParameters( int N, std::vector<parameter_type>& new_parameters )
{
    int Qa = M_model->Qa();
    int Ql = M_model->Ql( M_output_index );
    int dual_size = Ql * Ql + N * Qa * Ql + N * N * Qa * Qa;
...
template <typename TruthModelType>
void CRB<TruthModelType>::computePrimalApeeBasis( parameter_type const& mu ) const
{
    int N = M_WNmu->size();
    //compute RB solution
...
template <typename TruthModelType>
void CRB<TruthModelType>::computeDualApeeBasis( parameter_type const& mu ) const
{
    int N = M_WNmu->size();
    //compute RB solution
    std::vector<vectorN_type> uN_vector;
...
{
    int primal_rows = M_primal_T.rows();
    FEELPP_ASSERT( primal_rows >= N )
    ( primal_rows )( N ).error( "invalid size of RB dimension or M_primal_T is not correctly filled" );
...
{
    int dual_rows = M_dual_T.rows();
    FEELPP_ASSERT( dual_rows >= N )
    ( dual_rows )( N ).error( "invalid size of RB dimension or M_dual_T is not correctly filled" );
...
template <typename TruthModelType>
void CRB<TruthModelType>::computationalTimeStatistics( std::string appname )
{
...
template <typename TruthModelType>
template <class Archive>
void CRB<TruthModelType>::save( Archive& ar, const unsigned int version ) const
{
    int proc_number = this->worldComm().globalRank();
...
template <typename TruthModelType>
template <class Archive>
void CRB<TruthModelType>::load( Archive& ar, const unsigned int version )
{
...
template <typename TruthModelType>
bool CRB<TruthModelType>::printErrorDuringOfflineStep()
{
...
template <typename TruthModelType>
bool CRB<TruthModelType>::rebuildDB()
{
...
template <typename TruthModelType>
bool CRB<TruthModelType>::showMuSelection()
{
...
template <typename TruthModelType>
void CRB<TruthModelType>::saveDB()
{
...
template <typename TruthModelType>
bool CRB<TruthModelType>::loadDB()
{
    //if ( this->rebuildDB() )
    //    return false;
