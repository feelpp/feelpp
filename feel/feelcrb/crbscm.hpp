...
template <typename TruthModelType>
void CRBSCM<TruthModelType>::checkEigenVectorEigenValue( sparse_matrix_ptrtype const& A, sparse_matrix_ptrtype const& B, vector_ptrtype const& eigenvector, double eigenvalue ) const
{
...
template <typename TruthModelType>
void CRBSCM<TruthModelType>::checkC( size_type K ) const
{
...
template <typename TruthModelType>
void CRBSCM<TruthModelType>::computeYBounds()
{
    //std::cout << "************************************************************\n";
...
template <typename TruthModelType>
void CRBSCM<TruthModelType>::run( const double* X, unsigned long N, double* Y, unsigned long P )
{
    parameter_type mu( M_Dmu );
...
template <typename TruthModelType>
template <class Archive>
void CRBSCM<TruthModelType>::save( Archive& ar, const unsigned int version ) const
{
    if ( M_use_scm )
    {
        ar& M_use_scm;
...
template <typename TruthModelType>
template <class Archive>
void CRBSCM<TruthModelType>::load( Archive& ar, const unsigned int version )
{
...
template <typename TruthModelType>
bool CRBSCM<TruthModelType>::doScmForMassMatrix()
{
...
template <typename TruthModelType>
bool CRBSCM<TruthModelType>::rebuildDB()
{
...
template <typename TruthModelType>
void CRBSCM<TruthModelType>::saveDB()
{
...
template <typename TruthModelType>
bool CRBSCM<TruthModelType>::loadDB()
{
    if ( this->rebuildDB() )
        return false;
