...
class CRBSaddlePoint : public CRB<TruthModelType>
{
  ...
  public:
    ...
    CRBSaddlePoint( std::string name,
        ...
        : super_crb( name, vm, model ),
          M_crbdb( ( boost::format( "%1%" ) % ioption( "crb.error-type" ) ).str(),
                   name,
                   ( boost::format( "%1%-%2%-%3%-saddlepoint" ) % name % ioption( "crb.output-index" ) % ioption( "crb.error-type" ) ).str(),
                   vm )
    {
...
template <typename TruthModelType>
void CRBSaddlePoint<TruthModelType>::generateSampling()
{
...
template <typename TruthModelType>
template <class Archive>
void CRBSaddlePoint<TruthModelType>::save( Archive& ar, const unsigned int version ) const
{
...
template <typename TruthModelType>
template <class Archive>
void CRBSaddlePoint<TruthModelType>::load( Archive& ar, const unsigned int version )
{
...
template <typename TruthModelType>
void CRBSaddlePoint<TruthModelType>::saveDB()
{
    super_crb::saveDB();
...
template <typename TruthModelType>
bool CRBSaddlePoint<TruthModelType>::loadDB()
{
...
template <typename T>
const unsigned int version<Feel::CRBSaddlePoint<T>>::value;
