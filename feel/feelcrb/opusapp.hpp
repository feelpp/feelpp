                                ...
                                if( export_solution )
                                    {
                                        ...
                                        model->postProcess( exportName, u_pfem , mu);
                                    }
                        ...
                        case  CRBModelMode::CRB:
                            {
                                ...
                                if( export_solution )
                                {
                                    ...
                                    model->postProcess( exportName, u_crb , mu);
                                }
                                ...
                                if ( compute_fem )
                                {
                                    ...
                                    if( export_solution )
                                    {
                                        ...
                                        model->postProcess( exportName, u_fem, mu );
                                    }
                                    ...
                                    if( export_solution )
                                        {
                                            ...
                                            model->postProcess( exportName, u_error, mu );
                                        }
