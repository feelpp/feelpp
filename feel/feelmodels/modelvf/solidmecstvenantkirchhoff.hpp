...
inline Expr<StressStVenantKirchhoff<ElementType, ElementLameCoeffType, mpl::int_<0>>>
...
template <class ElementType, class ElementLameCoeffType>
inline Expr<StressStVenantKirchhoff<ElementType, ElementLameCoeffType, mpl::int_<1>>>
...
template <class ElementType, class ElementLameCoeffType>
inline Expr<StressStVenantKirchhoff<ElementType, ElementLameCoeffType, mpl::int_<2>>>
