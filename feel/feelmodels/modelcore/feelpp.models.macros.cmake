...
macro( genLibAdvection )
  PARSE_ARGUMENTS(FEELMODELS_APP
      "DIM;T_ORDER;GEO_ORDER;USE_PERIODICITY;POINT_SET;DIFFUSION_REACTION_ORDER;DIFFUSION_REACTION_CONTINUITY;"
    "NO_UPDATE_MODEL_DEF;ADD_CMAKE_INSTALL"
    ${ARGN}
    )
  ...
  set(FEELMODELS_MODEL_SPECIFIC_NAME_SUFFIX ${ADVECTION_DIM}dP${ADVECTION_ORDERPOLY}G${ADVECTION_ORDERGEO}${ADVECTION_POINT_SET_TAG}${ADVECTION_DIFFUSION_REACTION_TAG}${ADVECTION_PERIODICITY_TAG} )
