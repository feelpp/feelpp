...
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updatePicard( DataUpdateLinear& data ) const
{
    this->updateLinearPDE( data );
}

FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateLinearPDE( DataUpdateLinear& data ) const
{
