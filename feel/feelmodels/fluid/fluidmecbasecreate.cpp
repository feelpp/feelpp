...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::build()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::loadMesh( mesh_ptrtype __mesh )
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::loadParameterFromOptionsVm()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createWorldsComm()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createMesh()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createFunctionSpaces()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createTimeDiscretisation()
{
    ...
    M_bdf_fluid->setPathSave( ( fs::path( this->rootRepository() ) /
                                fs::path( prefixvm( this->prefix(), ( boost::format( "bdf_o_%1%_dt_%2%" ) % this->timeStep() % M_bdf_fluid->bdfOrder() ).str() ) ) )
                                  .string() );
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createALE()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createPostProcess()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createPostProcessExporters()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createOthers()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createFunctionSpacesNormalStress()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createFunctionSpacesVorticity()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createFunctionSpacesSourceAdded()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createBCFluidInlet()
{
    ...
    for ( auto const& inletbc : M_fluidInletDesc )
    {
        ...
        double flowRateRef = integrate( _range = markedfaces( this->mesh(), marker ),
                                        _expr = inner( idv( velinletRef ) * N(), N() ) )
                                 .evaluate()( 0, 0 );
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateFluidInletVelocity()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::init( bool buildMethodNum,
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateMarkedZonesInMesh()
{
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::initTimeStep()
{
    // start or restart time step scheme
    if ( !this->doRestart() )
    {
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::initFluidOutlet()
{
    // clean
    ...
    if ( this->hasFluidOutletWindkessel() )
    {
        ...
        else
        {
            if ( this->worldComm().isMasterRank() )
            {
                ...
                int cptIter = 0;
                double timeIter = 0;
                double valPresDistal = 0, valPresProximal = 0;
...
FLUIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::initPostProcess()
{
