...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::loadConfigBCFile()
{
    // clear
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::loadConfigPostProcess()
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::loadConfigMeshFile( std::string const& geofilename )
{
    CHECK( false ) << "not allow";
}

FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::init( bool buildModelAlgebraicFactory )
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateInHousePreconditionerPCD( sparse_matrix_ptrtype const& mat, vector_ptrtype const& vecSol ) const
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::solve()
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateInitialNewtonSolutionBCDirichlet( vector_ptrtype& U ) const
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCStrongDirichletLinearPDE( sparse_matrix_ptrtype& A, vector_ptrtype& F ) const
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCStrongDirichletJacobian( sparse_matrix_ptrtype& J, vector_ptrtype& RBis ) const
{
    if ( !this->hasDirichletBC() ) return;
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCStrongDirichletResidual( vector_ptrtype& R ) const
{
    if ( !this->hasDirichletBC() ) return;
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateSourceTermLinearPDE( vector_ptrtype& F, bool BuildCstPart ) const
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateSourceTermResidual( vector_ptrtype& F ) const
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCNeumannLinearPDE( vector_ptrtype& F ) const
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCNeumannResidual( vector_ptrtype& R ) const
{
    if ( M_bcNeumannScalar.empty() && M_bcNeumannVectorial.empty() && M_bcNeumannTensor2.empty() ) return;
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCPressureLinearPDE( vector_ptrtype& F ) const
{
#if 0  //TODO
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCPressureResidual( vector_ptrtype& R ) const
{
#if 0  //TODO
    auto const bcDef = FLUIDMECHANICS_BC(this->shared_from_this());
    if ( bcDef.hasPressure() )
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCDirichletLagMultLinearPDE( vector_ptrtype& F ) const
{
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCDirichletLagMultResidual( vector_ptrtype& R ) const
{
    if ( M_bcDirichlet.empty() ) return;
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCDirichletNitscheLinearPDE( vector_ptrtype& F ) const
{
    if ( M_bcDirichlet.empty() ) return;
    auto myLinearForm = form1( _test = this->functionSpace(), _vector = F,
                               _rowstart = this->rowStartInVector() );
...
FLUIDMECHANICS_CLASS_TEMPLATE_DECLARATIONS
void FLUIDMECHANICS_CLASS_TEMPLATE_TYPE::updateBCDirichletNitscheResidual( vector_ptrtype& R ) const
{
    if ( M_bcDirichlet.empty() ) return;
    auto myLinearForm = form1( _test = this->functionSpace(), _vector = R,
                               _rowstart = this->rowStartInVector() );
