...
// ALE
    ...
    typedef OperatorInterpolation<space_fluidinlet_type, component_space_fluid_velocity_type, //typename space_fluid_velocity_type::component_functionspace_type,
                                  range_marked_face_type>
        op_interpolation_fluidinlet_type;
...
// export ho
    ...
    typedef OperatorInterpolation<space_fluid_velocity_type,
                                  ...
                                  range_visu_ho_type>
        op_interpolation_visu_ho_vectorial_type;
    ...
    typedef OperatorInterpolation<space_fluid_pressure_type,
                                  ...
                                  range_visu_ho_type>
        op_interpolation_visu_ho_scalar_type;
    ...
    typedef OperatorInterpolation<space_mesh_disp_type,
                                  space_vectorial_visu_ho_type,
                                  range_visu_ho_type>
        op_interpolation_visu_ho_meshdisp_type;
    ...
    typedef OperatorInterpolation<space_stress_type,
                                  ...
                                  range_visu_ho_type>
        op_interpolation_visu_ho_vectorialdisc_type;
    ...
    typedef FeelModels::ThermoDynamics<convex_type,
                                       Lagrange<nOrderGeo, Scalar, Continuous, PointSetFekete>>
        thermodyn_model_type;
    ...
    element_vorticity_type const& fieldVorticity() const
    {
        CHECK( M_fieldVorticity ) << "fieldVorticity not init";
        return *M_fieldVorticity;
    }
    element_vorticity_type& fieldVorticity()
    {
        CHECK( M_fieldVorticity ) << "fieldVorticity not init";
        return *M_fieldVorticity;
    }
...
//TODO?
  ...
  protected:
    ...
    std::map<std::string, std::tuple<boost::shared_ptr<typename component_space_fluid_velocity_type::element_type>,
                                     op_interpolation_fluidinlet_ptrtype>>
        M_fluidInletVelocityInterpolated;
