...
void ModelAlgebraicFactory::init( graph_ptrtype const& graph,
                                  indexsplit_ptrtype const& indexSplit )
{
    this->application()->timerTool( "Constructor" ).start();
...
void ModelAlgebraicFactory::buildMatrixVector( graph_ptrtype const& graph,
                                               indexsplit_ptrtype const& indexSplit )
{
    //vectors
...
void ModelAlgebraicFactory::buildOthers()
{
...
void ModelAlgebraicFactory::rebuildMatrixVector( graph_ptrtype const& graph,
                                                 indexsplit_ptrtype const& indexSplit )
{
    M_hasBuildLinearJacobian = false;
    M_hasBuildResidualCst = false;
...
void ModelAlgebraicFactory::reset( backend_ptrtype __backend,
                                   graph_ptrtype const& graph,
                                   indexsplit_ptrtype const& indexSplit )
{
...
void ModelAlgebraicFactory::attachNullSpace( NullSpace<value_type> const& nullSpace )
{
...
void ModelAlgebraicFactory::attachNearNullSpace( NullSpace<value_type> const& nearNullSpace )
{
    CHECK( this->backend() ) << "backend not init\n";
...
void ModelAlgebraicFactory::attachNearNullSpace( int k, NullSpace<value_type> const& nearNullSpace )
{
    CHECK( this->backend() ) << "backend not init\n";
...
void ModelAlgebraicFactory::printInfo() const
{
    if ( this->application()->verboseAllProc() )
        std::cout << this->getInfo()->str();
    else if ( this->application()->worldComm().isMasterRank() )
        std::cout << this->getInfo()->str();
}

void ModelAlgebraicFactory::solve( std::string const& type, vector_ptrtype& sol )
{
...
void ModelAlgebraicFactory::linearSolver( vector_ptrtype& U )
{
...
void ModelAlgebraicFactory::updateJacobian( const vector_ptrtype& X, sparse_matrix_ptrtype& J /*, vector_ptrtype& R*/ )
{
    this->application()->timerTool( "Solve" ).start();
...
void ModelAlgebraicFactory::updateResidual( const vector_ptrtype& X, vector_ptrtype& R )
{
    this->application()->timerTool( "Solve" ).start();
...
void ModelAlgebraicFactory::AlgoNewton2( vector_ptrtype& U )
{
...
void ModelAlgebraicFactory::rebuildCstJacobian( vector_ptrtype U )
{
    M_CstJ->zero();
    //M_appli->updateJacobian( U, M_CstJ, M_R, true, M_Extended,false );
    ModelAlgebraic::DataUpdateJacobian dataJacobianCst( U, M_CstJ, M_R, true, M_Extended, false );
...
void ModelAlgebraicFactory::rebuildCstLinearPDE( vector_ptrtype U )
{
    M_CstJ->zero();
    M_CstR->zero();
    ModelAlgebraic::DataUpdateLinear dataLinearCst( U, M_CstJ, M_CstR, true, M_Extended, false );
...
void ModelAlgebraicFactory::AlgoPicard( vector_ptrtype U )
{
...
void ModelAlgebraicFactory::AlgoNewton( vector_ptrtype U )
{
#if 0
