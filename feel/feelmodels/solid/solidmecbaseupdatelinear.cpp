...
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateLinearPDE( DataUpdateLinear& data ) const
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateLinearElasticityGeneralisedAlpha( DataUpdateLinear& data ) const
{
