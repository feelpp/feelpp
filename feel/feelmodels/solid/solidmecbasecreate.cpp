...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::build()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::build( mesh_ptrtype mesh )
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::build( mesh_1dreduced_ptrtype mesh )
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::buildStandardModel( mesh_ptrtype mesh )
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::loadMesh( mesh_ptrtype mesh )
{
    if ( this->doRestart() )
        this->build();
    else
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::loadMesh( mesh_1dreduced_ptrtype mesh )
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::build1dReducedModel( mesh_1dreduced_ptrtype mesh )
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::loadParameterFromOptionsVm()
{
    ...
    else if ( timeSchema == "Generalized-Alpha" )
    {
        ...
        CHECK( false ) << "time scheme not supported : " << timeSchema << "\n";
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createWorldsComm()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createMesh()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createMesh1dReduced()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createFunctionSpaces()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createFunctionSpaces1dReduced()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createAdditionalFunctionSpacesNormalStress()
{
    if ( !M_XhNormalStress )
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createAdditionalFunctionSpacesStressTensor()
{
    if ( !M_XhStressTensor )
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createAdditionalFunctionSpacesFSI()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createAdditionalFunctionSpacesFSIStandard()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createAdditionalFunctionSpacesFSI1dReduced()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createTimeDiscretisation()
{
    ...
    M_timeStepNewmark->setPathSave( ( fs::path( this->rootRepository() ) /
                                      fs::path( prefixvm( this->prefix(), ( boost::format( "newmark_dt_%1%" ) % dt ).str() ) ) )
                                        .string() );
    ...
    if ( M_useDisplacementPressureFormulation )
    {
        ...
        M_savetsPressure->setPathSave( ( fs::path( this->rootRepository() ) /
                                         fs::path( prefixvm( this->prefix(), "save-pressure" ) ) )
                                           .string() );
    }
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createTimeDiscretisation1dReduced()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createExporters()
{
    ...
    else
    {
        ...
        else if ( hovisuSpaceUsed == "p1" )
        {
            ...
            CHECK( false ) << "invalid hovisu.space-used " << hovisuSpaceUsed;
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createExporters1dReduced()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::createOthers()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::init( bool buildAlgebraicFactory, typename model_algebraic_factory_type::appli_ptrtype const& app )
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::initTimeStep()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::initUserFunctions()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateUserFunctions( bool onlyExprWithTimeSymbol )
{
    if ( this->modelProperties().functions().empty() )
        return;
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::initPostProcess()
{
