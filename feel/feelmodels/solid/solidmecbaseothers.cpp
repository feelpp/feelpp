...
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::restartExporters( double time )
{
    // restart exporter
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::getInfo() const
{
    ...
    if ( isStandardModel() )
    {
        nElt = M_mesh->numGlobalElements();
        nDof = M_XhDisplacement->nDof();
    }
    else
    {
        nElt = M_mesh_1dReduced->numGlobalElements();
        nDof = M_Xh_1dReduced->nDof();
    }
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::pdeType( std::string __type )
{
    if ( __type == "Elasticity" )
    {
        M_pdeType = "Elasticity";
        M_pdeSolver = "LinearSystem";
    }
    else if ( __type == "Elasticity-Large-Deformation" )
    {
        M_pdeType = "Elasticity-Large-Deformation";
        M_pdeSolver = "Newton";
    }
    else if ( __type == "Hyper-Elasticity" )
    {
        M_pdeType = "Hyper-Elasticity";
        M_pdeSolver = "Newton";
    }
    else if ( __type == "Generalised-String" )
    {
        M_pdeType = "Generalised-String";
        M_pdeSolver = "LinearSystem";
    }
    else
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::pdeSolver( std::string __type )
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
int SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::nBlockMatrixGraph() const
{
    int nBlock = 1;
    if ( M_useDisplacementPressureFormulation )
        ++nBlock;
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateBlockVectorSolution()
{
    if ( this->isStandardModel() )
    {
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::exportResults( double time )
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::exportFieldsImpl( double time )
{
    if ( this->isStandardModel() )
    {
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::exportFieldsImplHO( double time )
{
    if ( this->isStandardModel() )
    {
#if defined( FEELPP_HAS_VTK )
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::exportMeasures( double time )
{
    if ( !this->isStandardModel() )
        return;
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateTimeStep()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::predictorDispl()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::solve( bool upVelAcc )
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateVelocity()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateNormalStressFromStruct()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateStressCriterions()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateInterfaceDispFrom1dDisp()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateInterfaceScalStressDispFromVectStress()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateInterfaceVelocityFrom1dVelocity()
{
...
SOLIDMECHANICSBASE_CLASS_TEMPLATE_DECLARATIONS
void SOLIDMECHANICSBASE_CLASS_TEMPLATE_TYPE::updateSubMeshDispFSIFromPrevious()
{
