...
template <class ConvexType>
void FSIMesh<ConvexType>::buildFSIMeshFromMsh()
{
...
template <class ConvexType>
void FSIMesh<ConvexType>::buildFSIMeshFromGeo()
{
    if ( this->worldComm().isMasterRank() )
...
template <class ConvexType>
void FSIMesh<ConvexType>::buildSubMesh( mesh_ptrtype const& fsimesh )
{
...
template <class ConvexType>
void FSIMesh<ConvexType>::buildMeshesPartitioning()
{
#ifdef FEELPP_HAS_HDF5
    if ( this->worldComm().isMasterRank() )
    {
