...
using tensor2_fixed_size_t = Eigen::TensorFixedSize<const value_type,Eigen::Sizes<M,N>>;

template<int M,int N, int P,typename value_type=double>
using tensor3_fixed_size_t = Eigen::TensorFixedSize<const value_type,Eigen::Sizes<M,N,P>>;
...
//!
template<int M,int N,typename value_type=double>
using tensor_map_fixed_size_matrix_t = Eigen::TensorMap<Eigen::TensorFixedSize<value_type,Eigen::Sizes<M,N>>>;
