...
solvereigenslepc_options( std::string const& prefix )
{
    ...
    _options.add_options()
        // solver options
        ( ( _prefix + "slepc-solver-type" ).c_str(), Feel::po::value<std::string>()->default_value( "krylovschur" ), "type of eigenvalue solver" )( ( _prefix + "slepc-nev" ).c_str(), Feel::po::value<int>()->default_value( 1 ), "number of requested eigenpairs" )( ( _prefix + "slepc-ncv" ).c_str(), Feel::po::value<int>()->default_value( 3 ), "number of basis vectors" )( ( _prefix + "slepc-tol" ).c_str(), Feel::po::value<double>()->default_value( 1e-10 ), "solver tolerance" )( ( _prefix + "slepc-nit" ).c_str(), Feel::po::value<int>()->default_value( 1000 ), "maximum number of iterations" );
...
template <typename T>
void SolverEigenSlepc<T>::setSlepcProblemType()
{
#if 1
    int ierr = 0;
...
template <typename T>
void SolverEigenSlepc<T>::setSlepcPositionOfSpectrum()
{
    int ierr = 0;
...
template <typename T>
void SolverEigenSlepc<T>::setSlepcSpectralTransform()
{
    int ierr = 0;
...
template <typename T>
void SolverEigenSlepc<T>::setSlepcDimensions()
{
    int ierr = 0;
