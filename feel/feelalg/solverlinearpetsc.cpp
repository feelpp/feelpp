                             ...
                             bool transpose )
{
    ...
    FEELPP_ASSERT( matrix != NULL )
        .error( "non petsc matrix structure" );
    FEELPP_ASSERT( precond != NULL )
        .error( "non petsc matrix structure" );
    FEELPP_ASSERT( solution != NULL )
        .error( "non petsc vector structure" );
    FEELPP_ASSERT( rhs != NULL )
        .error( "non petsc vector structure" );
...
template <typename T>
void SolverLinearPetsc<T>::getResidualHistory( std::vector<double>& hist )
{
    int ierr = 0;
    int its = 0;
...
template <typename T>
void SolverLinearPetsc<T>::setPetscConstantNullSpace()
{
    int ierr = 0;
    if ( this->M_nullSpace && this->M_nullSpace->size() > 0 )
    {
...
template <typename T>
void SolverLinearPetsc<T>::updateNullSpace( Mat A, Vec rhs )
{
...
template <typename T>
void SolverLinearPetsc<T>::updateNearNullSpace( Mat A )
{
...
template <typename T>
void SolverLinearPetsc<T>::setPetscSolverType()
{
    int ierr = 0;
...
template <typename T>
void SolverLinearPetsc<T>::setPetscPreconditionerType()
{
