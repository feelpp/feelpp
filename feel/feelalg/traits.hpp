...
#define FEELPP_GLAS_TRAITS_VECTOR_OP_CODE( T, V )                                                                                                            \
    ...
    inline size_type size( FEELPP_GLAS_TRAITS_VECTOR_TYPE( V ) < FEELPP_TRAITS_TYPE( T ) > const& t )                                                        \
    {                                                                                                                                                        \
        return t.FEELPP_GLAS_TRAITS_VECTOR_SIZE( V )();                                                                                                      \
    }                                                                                                                                                        \
    inline void resize( FEELPP_GLAS_TRAITS_VECTOR_TYPE( V ) < FEELPP_TRAITS_TYPE( T ) > &t, size_type newsize )                                              \
    {                                                                                                                                                        \
...
#define FEELPP_GLAS_TRAITS_MATRIX_OP_CODE( T, V )                                                                                    \
    ...
    inline size_type nrows( FEELPP_GLAS_TRAITS_MATRIX_TYPE( V )( FEELPP_TRAITS_TYPE( T ) ) const& t )                                \
    {                                                                                                                                \
        return t.FEELPP_GLAS_TRAITS_MATRIX_SIZE1( V )();                                                                             \
    }                                                                                                                                \
    inline size_type ncols( FEELPP_GLAS_TRAITS_MATRIX_TYPE( V )( FEELPP_TRAITS_TYPE( T ) ) const& t )                                \
    {                                                                                                                                \
        return t.FEELPP_GLAS_TRAITS_MATRIX_SIZE2( V )();                                                                             \
    }                                                                                                                                \
    inline void resize( FEELPP_GLAS_TRAITS_MATRIX_TYPE( V )( FEELPP_TRAITS_TYPE( T ) ) & t, size_type newsize1, size_type newsize2 ) \
    {                                                                                                                                \
