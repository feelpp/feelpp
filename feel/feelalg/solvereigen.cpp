...
solvereigen_options( std::string const& prefix )
{
    ...
    _options.add_options()
        ...
        ((_prefix+"solvereigen-position").c_str(), Feel::po::value<int>()->default_value( LARGEST_MAGNITUDE ), "eigenvalue solver position in spectrum")
        ...
        ((_prefix+"solvereigen-maxiter").c_str(), Feel::po::value<int>()->default_value( 1000 ), "maximum number of iterations");
