...
/* converged */
    ...
    case KSP_CONVERGED_CG_NEG_CURVE:
        return "CONVERGED_CG_NEG_CURVE";
    case KSP_CONVERGED_CG_CONSTRAINED:
        return "CONVERGED_CG_CONSTRAINED";
    case KSP_CONVERGED_STEP_LENGTH:
        return "CONVERGED_STEP_LENGTH";
    case KSP_CONVERGED_HAPPY_BREAKDOWN:
        return "CONVERGED_HAPPY_BREAKDOWN";
#if PETSC_VERSION_GREATER_OR_EQUAL_THAN( 3, 2, 0 )
    case KSP_CONVERGED_ATOL_NORMAL:
        return "CONVERGED_ATOL_NORMAL";
#endif
    ...
    case KSP_DIVERGED_BREAKDOWN_BICG:
        return "DIVERGED_BREAKDOWN_BICG";
    case KSP_DIVERGED_NONSYMMETRIC:
        return "DIVERGED_NONSYMMETRIC";
    case KSP_DIVERGED_INDEFINITE_PC:
        return "DIVERGED_INDEFINITE_PC";
#if PETSC_VERSION_LESS_THAN( 3, 4, 0 )
    case KSP_DIVERGED_NAN:
        return "DIVERGED_NAN";
#endif
    case KSP_DIVERGED_INDEFINITE_MAT:
        return "DIVERGED_INDEFINITE_MAT";

    case KSP_CONVERGED_ITERATING:
        return "CONVERGED_ITERATING";

    default:
        return "INDEFINE_KSP_REASON";
    }
} // PetscPCFactorSetMatSolverPackage
...
PetscConvertSNESReasonToString( SNESConvergedReason reason )
{
    ...
    case SNES_CONVERGED_FNORM_ABS:
        return "CONVERGED_FNORM_ABS"; // =  2, /* ||F|| < atol */
    case SNES_CONVERGED_FNORM_RELATIVE:
        return "CONVERGED_FNORM_RELATIVE"; // =  3, /* ||F|| < rtol*||F_initial|| */
#if PETSC_VERSION_GREATER_OR_EQUAL_THAN( 3, 3, 0 )
    case SNES_CONVERGED_SNORM_RELATIVE:
        return "CONVERGED_SNORM_RELATIVE"; // =  4, /* Newton computed step size small; || delta x || < stol */
#endif
    case SNES_CONVERGED_ITS:
        return "CONVERGED_ITS"; // =  5, /* maximum iterations reached */
    case SNES_CONVERGED_TR_DELTA:
        return "CONVERGED_TR_DELTA"; // =  7,
    /* diverged */
    case SNES_DIVERGED_FUNCTION_DOMAIN:
        return "DIVERGED_FUNCTION_DOMAIN"; // = -1, /* the new x location passed the function is not in the domain of F */
    case SNES_DIVERGED_FUNCTION_COUNT:
        return "DIVERGED_FUNCTION_COUNT"; // = -2,
    case SNES_DIVERGED_LINEAR_SOLVE:
        return "DIVERGED_LINEAR_SOLVE"; // = -3, /* the linear solve failed */
    case SNES_DIVERGED_FNORM_NAN:
        return "DIVERGED_FNORM_NAN"; // = -4,
    case SNES_DIVERGED_MAX_IT:
        return "DIVERGED_MAX_IT"; // = -5,
#if PETSC_VERSION_GREATER_OR_EQUAL_THAN( 3, 2, 0 )
    case SNES_DIVERGED_LINE_SEARCH:
        return "DIVERGED_LINE_SEARCH"; // = -6, /* the line search failed */
#endif
#if PETSC_VERSION_GREATER_OR_EQUAL_THAN( 3, 3, 0 )
    case SNES_DIVERGED_INNER:
        return "DIVERGED_INNER"; // = -7, /* inner solve failed */
#endif
    case SNES_DIVERGED_LOCAL_MIN:
        return "DIVERGED_LOCAL_MIN"; // = -8, /* || J^T b || is small, implies converged to local minimum of F() */

    case SNES_CONVERGED_ITERATING:
        return "CONVERGED_ITERATING"; // =  0

    default:
        return "INDEFINE_SNES_REASON";
    }
...
PetscGetMatStructureEnum( Feel::MatrixStructure matStruc )
{
    switch ( matStruc )
    {
    case Feel::SAME_NONZERO_PATTERN:
        return MatStructure::SAME_NONZERO_PATTERN;
    case Feel::DIFFERENT_NONZERO_PATTERN:
        return MatStructure::DIFFERENT_NONZERO_PATTERN;
#if PETSC_VERSION_LESS_THAN( 3, 5, 0 )
    case Feel::SAME_PRECONDITIONER:
        return MatStructure::SAME_PRECONDITIONER;
#endif
    case Feel::SUBSET_NONZERO_PATTERN:
        return MatStructure::SUBSET_NONZERO_PATTERN;
