...
class MatrixCondensed  : public boost::enable_shared_from_this<MatrixCondensed<T> >, public MatrixBlockBase<T>
{
public:
    
    using super = MatrixBlockBase<T>;
    using super2 = boost::enable_shared_from_this<MatrixCondensed<T> >;
    using value_type = T;
    ...
    virtual void addMatrix ( int* rows, int nrows,
        ...
        {
            return addMatrix( rows, nrows, cols, ncols, data, K, K2, mpl::bool_<do_condense>() );
        }
