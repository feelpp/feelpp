...
/*----------------------- functions ----------------------------------*/
template <typename T>
inline SolverLinearPetsc<T>::SolverLinearPetsc( WorldComm const& worldComm )
    : super( worldComm ),
...
template <typename T>
inline SolverLinearPetsc<T>::SolverLinearPetsc( po::variables_map const& vm, WorldComm const& worldComm )
    : super( vm, worldComm ),
      M_constant_null_space( false )
{
}
...
template <typename T>
inline SolverLinearPetsc<T>::~SolverLinearPetsc()
{
    this->clear();
}
} // Feel
