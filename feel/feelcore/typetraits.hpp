...
#define FEELPP_TRAITS_TYPES                                                                                               \
    BOOST_PP_TUPLE_TO_LIST(                                                                                               \
        ...
        (                                                                                                                 \
            QD_DD_TYPE                                                                                                    \
                QD_QD_TYPE                                                                                                \
                    MPFR_MP_TYPE( float, float, 1, 0, 7, std::numeric_limits<float>::epsilon() * factor_from_eps_fl, 0 ), \
...
#define FEELPP_TRAITS_OP_CODE( T )                                               \
    ...
    inline FEELPP_TRAITS_REAL_TYPE( T ) real( FEELPP_TRAITS_TYPE( T ) const& t ) \
    {                                                                            \
        boost::ignore_unused_variable_warning( t );                              \
        return FEELPP_TRAITS_FUNC_REAL( T, t );                                  \
    }                                                                            \
    inline FEELPP_TRAITS_REAL_TYPE( T ) imag( FEELPP_TRAITS_TYPE( T ) const& t ) \
    {                                                                            \
        boost::ignore_unused_variable_warning( t );                              \
        return FEELPP_TRAITS_FUNC_IMAG( T, t );                                  \
    }                                                                            \
    inline FEELPP_TRAITS_TYPE( T ) conj( FEELPP_TRAITS_TYPE( T ) const& t )      \
    {                                                                            \
        boost::ignore_unused_variable_warning( t );                              \
...
#define FEELPP_UNARY_FUNCS_OP_CODE( T, F )                                                   \
    inline FEELPP_TRAITS_TYPE( T ) FEELPP_FUNC_NAME( F )( FEELPP_TRAITS_TYPE( T ) const& t ) \
    {                                                                                        \
...
#define FEELPP_BINARY_FUNCS_OP_CODE( T, F )                                                                  \
    ...
    inline FEELPP_TRAITS_TYPE( T ) FEELPP_FUNC_NAME( F )( FEELPP_TRAITS_TYPE( T ) const& x, Type2 const& y ) \
    {                                                                                                        \
