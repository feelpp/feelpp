...
BOOST_PARAMETER_FUNCTION(
    ...
    ( required( name, *(boost::is_convertible<mpl::_, std::string>)) )( optional( prefix, ( std::string ), "" )( worldcomm, *, Environment::worldComm() )( shape, *(boost::is_convertible<mpl::_, std::string>), soption( _prefix = prefix, _name = "gmsh.domain.shape" ) )( shear, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.shear" ) )( recombine, *(boost::is_integral<mpl::_>), boption( _prefix = prefix, _name = "gmsh.domain.recombine" ) )( dim, *(boost::is_integral<mpl::_>), 3 )( order, *(boost::is_integral<mpl::_>), 1 )( geo_parameters, *(boost::icl::is_map<mpl::_>), Gmsh::gpstr2map( "" ) )( h, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.hsize" ) )( convex, *(boost::is_convertible<mpl::_, std::string>), soption( _prefix = prefix, _name = "gmsh.domain.convex" ) )( addmidpoint, *(boost::is_integral<mpl::_>), boption( _prefix = prefix, _name = "gmsh.domain.addmidpoint" ) )( usenames, *(boost::is_integral<mpl::_>), boption( _prefix = prefix, _name = "gmsh.domain.usenames" ) )( xmin, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.xmin" ) )( xmax, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.xmax" ) )( ymin, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.ymin" ) )( ymax, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.ymax" ) )( zmin, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.zmin" ) )( zmax, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.zmax" ) )( nx, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.nx" ) )( ny, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.ny" ) )( nz, *(boost::is_arithmetic<mpl::_>), doption( _prefix = prefix, _name = "gmsh.domain.ny" ) )( substructuring, *(boost::is_integral<mpl::_>), boption( _prefix = prefix, _name = "gmsh.domain.substructuring" ) ) ) )
{
