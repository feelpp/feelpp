...
#include <feel/feelfilters/gmsh.cpp>
    ...
    namespace GeoTool {
        ...
        public:
            ...
            */
            ...
            uint cptTableau() const { return _M_cptTableau;}//voir les extrudes par exemple
...
#define GEOTOOL_GENERATE_RUN(r,state)                                   \
        ...
        void writePoint(uint __numLoc, data_geo_ptrtype __dg ,double __x1,double __x2=0, double __x3=0)
        {
