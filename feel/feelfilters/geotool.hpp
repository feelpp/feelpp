...
class GeoToolPoint
{
  public:
    ...
    {
        return ( math::abs( this->node()[0] - p.node()[0] ) < 1e-9 ) &&
  ...
  public:
          ...
          M_lineType( type )
    {
        CHECK( type == "line" ||
               ...
               type == "spline" || type == "bspline" )
            << "invalid line type " << type;
    }
...
class GeoGMSHTool
{
  ...
  public:
    ...
    BOOST_PARAMETER_MEMBER_FUNCTION(
        ...
        setMarker,
        tag,
        ( required( type, ( std::string ) )( name, ( std::string ) ) )( optional( markerAll, (bool), false )( marker1, (bool), false )( marker2, (bool), false )( marker3, (bool), false )( marker4, (bool), false )( marker5, (bool), false )( marker6, (bool), false )( marker7, (bool), false )( marker8, (bool), false )( marker9, (bool), false )( marker10, (bool), false )( marker11, (bool), false )( marker12, (bool), false ) ) )
    {
    ...
    BOOST_PARAMETER_MEMBER_FUNCTION(
        ...
        tag,
        ( required( mesh, * )( name, ( std::string ) ) )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 //required
        ( optional( format, *, ioption( _name = "gmsh.format" ) )( straighten, *(boost::is_integral<mpl::_>), 1 )( refine, *(boost::is_integral<mpl::_>), 0 )( partitions, *(boost::is_integral<mpl::_>), Environment::worldComm().size() )( partition_file, *(boost::is_integral<mpl::_>), 0 )( partitioner, *(boost::is_integral<mpl::_>), GMSH_PARTITIONER_CHACO )( worldcomm, *, Environment::worldComm() )( hmin, (double), 0 )( hmax, (double), 1e22 )( optimize3d_netgen, *(boost::is_integral<mpl::_>), true )( update, *(boost::is_integral<mpl::_>), MESH_UPDATE_FACES | MESH_UPDATE_EDGES ) ) //optional
        )
    {
...
void writePoint( uint16_type __numLoc, data_geo_ptrtype __dg, node_type const& _node );
void writePoint( uint16_type __numLoc, data_geo_ptrtype __dg, double __x1, double __x2 = 0, double __x3 = 0 );
...
void writePtInSurface( data_geo_ptrtype __dg, uint16_type __indPt, uint16_type __indSurf );
        ...
        ( double __meshSize,                                                                                      \
          ...
          GEOTOOL_SHAPE_PARAM_SIGNATURE( state )                                                                  \
              uint16_type type = 0 ); /*Ne sert a rien, juste a cause de la virgule au dessus)*/                  \
                                                                                                                  \
        GEOTOOL_SHAPE_NAME_CLASS( BOOST_PP_TUPLE_ELEM( 2, 0, state ) )                                            \
        ( const GEOTOOL_SHAPE_NAME_CLASS( BOOST_PP_TUPLE_ELEM( 2, 0, state ) ) & m )                              \
            : GeoGMSHTool( m ),                                                                                   \
              M_param( m.M_param )                                                                                \
        {                                                                                                         \
        }                                                                                                         \
