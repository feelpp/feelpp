...
class ADBinaryAdd
{
  ...
  public:
    ADBinaryAdd( const L& left, const R& rigth )
        : __left( left ), __right( rigth )
    {
        ;
    }
    ~ADBinaryAdd()
...
class ADBinarySubtract
{
  ...
  public:
    ADBinarySubtract( const L& left, const R& rigth )
        : __left( left ), __right( rigth )
    {
        ;
    }
...
class ADBinaryMultiply
{
  ...
  public:
    ADBinaryMultiply( const L& left, const R& rigth )
        : __left( left ), __right( rigth )
    {
        ;
    }
...
class ADBinaryDivide
{
  ...
  public:
    ADBinaryDivide( const L& left, const R& rigth )
        : __left( left ), __right( rigth )
    {
        ;
    }
    ...
    value_type hessian( int __i, int __j ) const
    {
        return -( -__left.hessian( __i, __j ) * __right.value() * __right.value() +
                  ...
                  __left.value() * __right.value() * __right.hessian( __i, __j ) ) /
               ( __right.value() * __right.value() * __right.value() );
    };
...
class ADBinaryPow
{
  ...
  public:
    ADBinaryPow( const L& left, const R& rigth )
        : __left( left ), __right( rigth )
    {
        ;
    }
    ...
    value_type grad( int i ) const
    {
        return ( __right.grad( i ) * std::log( __left.value() ) + __right.value() * __left.grad( i ) / __left.value() ) * std::pow( __left.value(), __right.value() );
    }
