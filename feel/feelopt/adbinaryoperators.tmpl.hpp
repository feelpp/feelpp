...
inline ADExpr<@STYPE @<ADExpr<E1>, ADExpr<E2>>> @OP @( const ADExpr<E1>& v, const ADExpr<E2>& w )
{
    typedef @STYPE @<ADExpr<E1>, ADExpr<E2>> expr_t;
    return ADExpr<expr_t>( expr_t( v, w ) );
}
template <class E, int Nvar, int order, int Var>
inline ADExpr<@STYPE @<ADExpr<E>, ADType<typename E::value_type, Nvar, order, Var>>> @OP @( const ADExpr<E>& e, const ADType<typename E::value_type, Nvar, order, Var>& v )
{
...
inline ADExpr<@STYPE @<ADType<A, Nvar, order, Var1>, ADType<A, Nvar, order, Var2>>> @OP @( const ADType<A, Nvar, order, Var1>& e1, const ADType<A, Nvar, order, Var2>& e2 )
{
...
template <class E, int Nvar, int order, int Var>
inline ADExpr<@STYPE @<ADType<typename E::value_type, Nvar, order, Var>, ADExpr<E>>> @OP @( const ADType<typename E::value_type, Nvar, order, Var>& v, const ADExpr<E>& e )
{
    typedef typename E::value_type A;
...
inline ADExpr<@STYPE @<ADCst<C>, ADType<A, Nvar, order, Var>>> @OP @( C a, const ADType<A, Nvar, order, Var>& e )
{
...
template <typename A, typename C, int Nvar, int order, int Var>
inline ADExpr<@STYPE @<ADType<A, Nvar, order, Var>, ADCst<C>>> @OP @( const ADType<A, Nvar, order, Var>& e, C a )
{
...
inline ADExpr<@STYPE @<ADCst<C>, ADExpr<E>>> @OP @( C t, const ADExpr<E>& e )
{
...
template <class E, class C>
inline ADExpr<@STYPE @<ADExpr<E>, ADCst<C>>> @OP @( const ADExpr<E>& e, C t )
{
