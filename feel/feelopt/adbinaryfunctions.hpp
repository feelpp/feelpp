...
public:
    ...
    inline value_type value() const  { return Value<St::STypeTraits<value_type>::isFundamental,Expr1,Expr2>::value(expr1_, expr2_);}
    inline value_type grad(int __i) const {return  Value<St::STypeTraits<value_type>::isFundamental,Expr1,Expr2>::grad(expr1_, expr2_, __i); }
    inline value_type hessian(int __i, int __j) const {return  Value<St::STypeTraits<value_type>::isFundamental,Expr1, Expr2>::hessian(expr1_, expr2_, __i, __j); }
