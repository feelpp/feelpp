...
public:
@NAME @( const Expr1& expr1, const Expr2& expr2 )
...
template <class Expr1, class Expr2>
inline ADExpr<@NAME @<ADExpr<Expr1>, ADExpr<Expr2>>> @FCT @( const ADExpr<Expr1>& expr1, const ADExpr<Expr2>& expr2 )
{
...
inline ADExpr<@NAME @<ADType<T, Nvar, Order, Var>, ADType<T, Nvar, Order, Var>>> @FCT @( const ADType<T, Nvar, Order, Var>& x, const ADType<T, Nvar, Order, Var>& y )
{
...
inline ADExpr<AdFuncPow<ADType<T, Nvar, Order, Var>, ADCst<W>>>
