...
#define VF_IM_ORDER( O, L, R )                                                                                                                                                                                      \
    BOOST_PP_IF( BOOST_PP_EQUAL( VF_OP_IMORDER( O ), 0 ),                                                                                                                                                           \
                 ...
                 BOOST_PP_IF( BOOST_PP_EQUAL( VF_OP_IMORDER( O ), 1 ),                                                                                                                                              \
                              ( VF_TYPE_TYPE( L )::imorder < VF_TYPE_TYPE( R )::imorder ) * VF_TYPE_TYPE( R )::imorder + ( VF_TYPE_TYPE( L )::imorder >= VF_TYPE_TYPE( R )::imorder ) * VF_TYPE_TYPE( L )::imorder, \
    ...
    {                                                                                                                                                                                                                \
      public:                                                                                                                                                                                                        \
        ...
        typedef value_type evaluate_type;                                                                                                                                                                            \
                                                                                                                                                                                                                     \
        VF_OP_NAME( O )                                                                                                                                                                                              \
        ( L_type const& left, R_type const& right )                                                                                                                                                                  \
            : M_left( left ),                                                                                                                                                                                        \
              M_right( right )                                                                                                                                                                                       \
        {                                                                                                                                                                                                            \
        }                                                                                                                                                                                                            \
        VF_OP_NAME( O )                                                                                                                                                                                              \
        ( VF_OP_NAME( O ) const& __m )                                                                                                                                                                               \
            : M_left( __m.M_left ),                                                                                                                                                                                  \
              M_right( __m.M_right )                                                                                                                                                                                 \
        {                                                                                                                                                                                                            \
            ;                                                                                                                                                                                                        \
    ...
    template <BOOST_PP_IF( VF_TYPE_IS_EXPR( L ),                                                                                                                                                                     \
                  ...
                  BOOST_PP_IF( BOOST_PP_AND( VF_TYPE_IS_EXPR( L ),                                                                                                                                                   \
                      ...
                      BOOST_PP_IF( VF_TYPE_IS_EXPR( R ),                                                                                                                                                             \
                                   BOOST_PP_IDENTITY( class VF_TYPE_NAME( R ) ),                                                                                                                                     \
                                   BOOST_PP_EMPTY )()>                                                                                                                                                               \
        inline Expr<VF_OP_NAME( O ) < VF_TYPE_TYPE_EXPR_CST( L ), VF_TYPE_TYPE_EXPR_CST( R )>>                                                                                                                       \
