...
BOOST_PARAMETER_FUNCTION(
    ...
    ( required( context, * )( expr, * ) ) // 4. one required parameter, and

    ( optional( max_points_used, (int), -1 )( geomap, *, GeomapStrategyType::GEOMAP_OPT )( mpi_communications, (bool), true )( projection, (bool), false ) ) )
{
