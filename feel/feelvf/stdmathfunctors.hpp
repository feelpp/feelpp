...
#define VF_UNARY_FUNCTIONS_CODE( O )                                                                                        \
    ...
    {                                                                                                                       \
      ...
      protected:                                                                                                            \
        ...
        expression_1_type M_expr_1;                                                                                         \
                                                                                                                            ...
                                                                                                                            \
    template <typename ExprT1>                                                                                              \
        inline Expr<VF_FUNC_NAME( O ) < typename mpl::if_<boost::is_arithmetic<ExprT1>,                                     \
    ...
    template <typename ExprT1>                                                                                              \
        inline Expr<VF_FUNC_NAME( O ) < Cst<ExprT1>>>                                                                       \
...
#define VF_BINARY_FUNCTIONS_CODE( O )                                                                                                           \
    ...
    {                                                                                                                                           \
      public:                                                                                                                                   \
        ...
        {                                                                                                                                       \
            ...
            struct is_zero                                                                                                                      \
            {                                                                                                                                   \
                static const bool value = false /*tensor2_expr_type::is_zero::value*/;                                                          \
            };                                                                                                                                  \
                                                                                                                                                \
            tensor( this_type const& expr, Geo_t const& geom, Basis_i_t const& /*fev*/, Basis_j_t const& /*feu*/ )                              \
    ...
    template <typename ExprT1, typename ExprT2>                                                                                                 \
        inline Expr<VF_FUNC_NAME( O ) < Cst<ExprT1>, Cst<ExprT2>>>                                                                              \
