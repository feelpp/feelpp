...
class Evaluator
{
  public:
    ...
    typedef typename mpl::if_<mpl::bool_<mesh_element_type::is_simplex>,
                              ...
                              mpl::identity<typename Pset::template apply<mesh_element_type::nRealDim, value_type, Hypercube>::type>>::type::type pointset_type;
    ...
    Evaluator<iDim, Iterator, Pset, ExprT>::operator()( mpl::size_t<MESH_FACES> ) const
{
    ...
    for ( int e = 0; __face_it != __face_en; ++__face_it, ++e )
    {
        ...
        ( __face_it->marker() )( __face_it->isOnBoundary() )( __face_it->ad_first() )( __face_it->pos_first() )( __face_it->ad_second() )( __face_it->pos_second() )( __face_it->id() ).warn( "inconsistent data face" );
...
BOOST_PARAMETER_FUNCTION(
    ...
    ( required( range, * )( pset, * )(expr, *)) // 4. one required parameter, and

    ( optional( geomap, *, GeomapStrategyType::GEOMAP_OPT ) ) )
{
...
struct normLinfData : public boost::tuple<double, Eigen::Matrix<double, Dim, 1>>
{
    ...
    normLinfData( double v, Eigen::Matrix<double, Dim, 1> const& x )
        : super( v, x ) {}
...
BOOST_PARAMETER_FUNCTION(
    ...
    ( optional( worldcomm, ( WorldComm ), Environment::worldComm() )( geomap, *, GeomapStrategyType::GEOMAP_OPT ) ) )
{
    ...
    auto it_max = std::max_element( D_world.begin(), D_world.end(),
                                    []( auto const& d1, auto const& d2 ) { return d1.value() < d2.value(); } );
