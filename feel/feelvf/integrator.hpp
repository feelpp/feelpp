  ...
  public:
    ...
    struct eval
    {
        ...
        typedef typename mpl::if_<mpl::bool_<the_element_type::is_simplex>,
                                  ...
                                  mpl::identity<typename Im::template apply<the_element_type::nDim, expression_value_type, Hypercube>::type>>::type::type im_type;

        typedef typename mpl::if_<mpl::bool_<the_element_type::is_simplex>,
                                  mpl::identity<typename Im2::template apply<the_element_type::nDim, expression_value_type, Simplex>::type>,
                                  mpl::identity<typename Im2::template apply<the_element_type::nDim, expression_value_type, Hypercube>::type>>::type::type im2_type;
...
template <typename Elem1, typename Elem2, typename FormType>
void Integrator<Elements, Im, Expr, Im2>::assemble( boost::shared_ptr<Elem1> const& __u,
                                                    boost::shared_ptr<Elem2> const& __v,
                                                    FormType& __form ) const
{
#if 0
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename Elem1, typename FormType>
void Integrator<Elements, Im, Expr, Im2>::assemble( boost::shared_ptr<Elem1> const& __v,
                                                    FormType& __form ) const
{
#if 0
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FormType>
void Integrator<Elements, Im, Expr, Im2>::assemble( FormType& __form, mpl::int_<MESH_ELEMENTS> /**/, mpl::bool_<true> /**/, bool /*hasRelation*/, mpl::false_ ) const
{
    boost::timer __timer;
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FormType>
void Integrator<Elements, Im, Expr, Im2>::assemble( FormType& __form, mpl::int_<MESH_ELEMENTS> /**/,
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FormType>
void Integrator<Elements, Im, Expr, Im2>::assemble( FormType& __form, mpl::int_<MESH_ELEMENTS> /**/, mpl::bool_<false> /**/, bool hasRelation ) const
{
    if ( hasRelation )
    {
...
template <typename SpaceType, typename ImType, typename GmcType, typename GmcExprType>
void updateGmcWithRelationDifferentMeshType( boost::shared_ptr<SpaceType> const& /*space*/,
...
void updateGmcWithRelationDifferentMeshType2( FaceType const& theface, boost::shared_ptr<SpaceType> const& /*space*/,
                                              boost::shared_ptr<GmcType> /*gmc*/, boost::shared_ptr<GmcExprType> /*gmcExpr*/,
                                              size_type /*idElt*/, mpl::int_<0> /**/ )
{
    // nothing to do!
                                              ...
                                              size_type idElt, mpl::int_<1> /**/ )
{
          ...
          __p < permutation_type( permutation_type::N_PERMUTATIONS ) && !findPermutation; ++__p )
    {
        ...
        if ( check )
        {
            gmcExpr->update( theface.element0(), theface.pos_first(), __p );
            findPermutation = true;
        }
    }
    CHECK( findPermutation ) << "the permutation of quad point is not find\n";
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE1, typename FE2, typename ElemContType>
void Integrator<Elements, Im, Expr, Im2>::assembleWithRelationDifferentMeshType( vf::detail::BilinearForm<FE1, FE2, ElemContType>& __form,
                                                                                 mpl::int_<MESH_ELEMENTS> /**/, mpl::false_ ) const
{
    ...
    typedef typename mpl::if_<mpl::bool_<eval::the_element_type::is_simplex>,
                              ...
                              mpl::identity<typename Im::template applyIMGeneral<eval::the_element_type::nDim, expression_value_type, Hypercube>::type>>::type::type im_range_type;
    typedef typename mpl::if_<mpl::bool_<eval::the_element_type::is_simplex>,
                              mpl::identity<typename Im2::template applyIMGeneral<eval::the_element_type::nDim, expression_value_type, Simplex>::type>,
                              mpl::identity<typename Im2::template applyIMGeneral<eval::the_element_type::nDim, expression_value_type, Hypercube>::type>>::type::type im1_range_type;

    typedef typename mpl::if_<mpl::bool_<eval::the_element_type::is_simplex>,
                              mpl::identity<typename Im::template applyIMGeneral<geoelement_formTest_type::nDim, expression_value_type, Simplex>::type>,
                              mpl::identity<typename Im::template applyIMGeneral<geoelement_formTest_type::nDim, expression_value_type, Hypercube>::type>>::type::type im_formtest_type;
    typedef typename mpl::if_<mpl::bool_<eval::the_element_type::is_simplex>,
                              mpl::identity<typename Im2::template applyIMGeneral<geoelement_formTest_type::nDim, expression_value_type, Simplex>::type>,
                              mpl::identity<typename Im2::template applyIMGeneral<geoelement_formTest_type::nDim, expression_value_type, Hypercube>::type>>::type::type im1_formtest_type;

    typedef typename mpl::if_<mpl::bool_<eval::the_element_type::is_simplex>,
                              mpl::identity<typename Im::template applyIMGeneral<geoelement_formTrial_type::nDim, expression_value_type, Simplex>::type>,
                              mpl::identity<typename Im::template applyIMGeneral<geoelement_formTrial_type::nDim, expression_value_type, Hypercube>::type>>::type::type im_formtrial_type;
    typedef typename mpl::if_<mpl::bool_<eval::the_element_type::is_simplex>,
                              mpl::identity<typename Im2::template applyIMGeneral<geoelement_formTrial_type::nDim, expression_value_type, Simplex>::type>,
                              mpl::identity<typename Im2::template applyIMGeneral<geoelement_formTrial_type::nDim, expression_value_type, Hypercube>::type>>::type::type im1_formtrial_type;
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE, typename VectorType, typename ElemContType>
void Integrator<Elements, Im, Expr, Im2>::assembleWithRelationDifferentMeshType( vf::detail::LinearForm<FE, VectorType, ElemContType>& __form, mpl::int_<MESH_ELEMENTS> /**/ ) const
{
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE1, typename FE2, typename ElemContType>
void Integrator<Elements, Im, Expr, Im2>::assembleInCaseOfInterpolate( vf::detail::BilinearForm<FE1, FE2, ElemContType>& __form,
                                                                       mpl::int_<MESH_ELEMENTS> /**/, mpl::false_ ) const
{
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE, typename VectorType, typename ElemContType>
void Integrator<Elements, Im, Expr, Im2>::assembleInCaseOfInterpolate( vf::detail::LinearForm<FE, VectorType, ElemContType>& __form, mpl::int_<MESH_ELEMENTS> /**/ ) const
{
    typedef typename mpl::if_<mpl::bool_<eval::the_element_type::is_simplex>,
                              mpl::identity<typename Im::template applyIMGeneral<eval::the_element_type::nDim, expression_value_type, Simplex>::type>,
                              mpl::identity<typename Im::template applyIMGeneral<eval::the_element_type::nDim, expression_value_type, Hypercube>::type>>::type::type im_range_type;
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE1, typename FE2, typename ElemContType, typename FaceRangeType>
bool Integrator<Elements, Im, Expr, Im2>::useSameMesh( vf::detail::BilinearForm<FE1, FE2, ElemContType>& __form,
                                                       FaceRangeType const& faceRange ) const
{
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE, typename VectorType, typename ElemContType, typename FaceRangeType>
bool Integrator<Elements, Im, Expr, Im2>::useSameMesh( vf::detail::LinearForm<FE, VectorType, ElemContType>& __form,
                                                       FaceRangeType const& faceRange ) const
{
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE1, typename FE2, typename ElemContType, typename FaceRangeType>
bool Integrator<Elements, Im, Expr, Im2>::faceIntegratorUseTwoConnections( vf::detail::BilinearForm<FE1, FE2, ElemContType>& __form,
                                                                           FaceRangeType const& faceRange,
                                                                           typename vf::detail::BilinearForm<FE1, FE2, ElemContType>::mesh_1_type::element_type const& eltTest,
                                                                           uint16_type faceIdInElt ) const
{
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE, typename VectorType, typename ElemContType, typename FaceRangeType>
bool Integrator<Elements, Im, Expr, Im2>::faceIntegratorUseTwoConnections( vf::detail::LinearForm<FE, VectorType, ElemContType>& __form,
                                                                           FaceRangeType const& faceRange,
                                                                           typename vf::detail::LinearForm<FE, VectorType, ElemContType>::mesh_type::element_type const& eltTest,
                                                                           uint16_type faceIdInElt ) const
{
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FormType>
void Integrator<Elements, Im, Expr, Im2>::assemble( FormType& __form, mpl::int_<MESH_FACES> /**/, mpl::bool_<true> /**/, bool /*hasRelation*/ ) const
{
    ...
    for ( auto lit = M_elts.begin(), len = M_elts.end(); lit != len; ++lit )
    {
        ...
        for ( ; it != en; ++it )
        {
            ...
            if ( this->faceIntegratorUseTwoConnections( __form, faceCur, elt0Test, __face_id_in_elt_0 ) )
            {
                ...
                case GeomapStrategyType::GEOMAP_HO:
                {
                          ...
                          __p < permutation_type( permutation_type::N_PERMUTATIONS ) && !findPermutation; ++__p )
                    {
                        ...
                        if ( check )
                        {
                            __c1->update( elt1Test, __face_id_in_elt_1, __p );
                            findPermutation = true;
                        }
                    }
                    CHECK( findPermutation ) << "the permutation of quad point is not find\n";
                ...
                case GeomapStrategyType::GEOMAP_OPT:
                {
                          ...
                          __p < permutation_type( permutation_type::N_PERMUTATIONS ) && !findPermutation; ++__p )
                    {
                        ...
                        if ( check )
                        {
                            __c11->update( elt1Test, __face_id_in_elt_1, __p );
                            findPermutation = true;
                        }
                    }
                    CHECK( findPermutation ) << "the permutation of quad point is not find\n";
            ...
            else
            {
                ...
                ( __face_id_in_elt_0 )( __c0->faceId() ).warn( "invalid face id" );
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FormType>
void Integrator<Elements, Im, Expr, Im2>::assemble( FormType& __form, mpl::int_<MESH_FACES> /**/, mpl::bool_<false> /**/, bool hasRelation ) const
{
    if ( hasRelation )
    {
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE, typename VectorType, typename ElemContType>
void Integrator<Elements, Im, Expr, Im2>::assembleWithRelationDifferentMeshType( vf::detail::LinearForm<FE, VectorType, ElemContType>& __form, mpl::int_<MESH_FACES> /**/ ) const
{
    // typedef on integral mesh (expr) :
    typedef typename eval::gm_type gm_expr_type;
    typedef typename eval::gm1_type gm1_expr_type;
...
template <typename Elements, typename Im, typename Expr, typename Im2>
template <typename FE, typename VectorType, typename ElemContType>
void Integrator<Elements, Im, Expr, Im2>::assembleInCaseOfInterpolate( vf::detail::LinearForm<FE, VectorType, ElemContType>& __form, mpl::int_<MESH_FACES> /**/ ) const
{
    ...
    Integrator<Elements, Im, Expr, Im2>::evaluate( mpl::int_<MESH_ELEMENTS> ) const
{
        ...
        if ( boption( _name = "parallel.cpu.enable" ) && soption( _name = "parallel.cpu.impl" ).find( "harts." ) == 0 )
    {
        ...
        for ( int i = 0; i < nbThreads; i++ )
        {
            ...
            if ( i == 0 )
            {
                perf_mng.stop( "init2.2.0" );
            }
            if ( i == 0 )
            {
                perf_mng.start( "init2.2.1" );
            }
            hce.push_back( t );
            if ( i == 0 )
            {
                perf_mng.stop( "init2.2.1" );
            }
            if ( i == 0 )
            {
                perf_mng.start( "init2.2.2" );
            }
            TaskType* task = new TaskType( t );
            if ( i == 0 )
            {
                perf_mng.stop( "init2.2.2" );
            }
            if ( i == 0 )
            {
                perf_mng.start( "init2.2.3" );
            }
...
integrate_impl( Elts const& elts,
                ...
                boost::shared_ptr<QuadPtLocalization<typename Feel::detail::quadptlocrangetype<Elts>::type, Im, ExprT>> quadptloc = boost::shared_ptr<QuadPtLocalization<typename Feel::detail::quadptlocrangetype<Elts>::type, Im, ExprT>>() )
{
