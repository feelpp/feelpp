...
journal_options( std::string const& prefix )
{
    ...
    options.add_options()
        ...
        ( prefixvm( prefix,"journal.auto.mesh" ).c_str(), Feel::po::value<bool>()->default_value(true), "Enable simulation info" )
        ( prefixvm( prefix,"journal.auto.functionspace" ).c_str(), Feel::po::value<bool>()->default_value(true), "Enable simulation info" )
