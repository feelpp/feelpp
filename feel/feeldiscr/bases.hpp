      ...
      public boost::fusion::vector<Args...>
{
    ...
    Periodicity()
        : super() {}
    Periodicity( super const& m )
        : super( m ) {}
    Periodicity( Args... args )
        : super( fusion::make_vector( args... ) ) {}
...

{
    ...
    Periodicity( super const& m )
        : super( m ) {}
    Periodicity( A0 a0 )
        : super( fusion::make_vector( a0 ) ) {}
    Periodicity( A0 a0, A1 a1 )
        : super( fusion::make_vector( a0, a1 ) ) {}
    Periodicity( A0 a0, A1 a1, A2 a2 )
        : super( fusion::make_vector( a0, a1, a2 ) ) {}
    Periodicity( A0 a0, A1 a1, A2 a2, A3 a3 )
        : super( fusion::make_vector( a0, a1, a2, a3 ) ) {}
