...
typedef parameter::parameters<
    parameter::required<tag::mesh_type, boost::is_base_and_derived<MeshBase, _>>, parameter::optional<parameter::deduced<tag::bases_list>, boost::is_base_and_derived<Feel::detail::bases_base, _>>, parameter::optional<parameter::deduced<tag::value_type>, boost::is_floating_point<_>>, parameter::optional<parameter::deduced<tag::mortar_type>, boost::is_base_and_derived<Feel::detail::mortar_base, _>>, parameter::optional<parameter::deduced<tag::periodicity_type>, boost::is_base_and_derived<Feel::detail::periodicity_base, _>>>
  ...
  public:
    ...
    struct GetNComponents
    {
        ...
        typedef mpl::int_<BasisType::template apply<mesh_type::nDim,
                                                    mesh_type::nRealDim,
                                                    value_type,
                                                    typename mesh_type::element_type>::type::nComponents>
            type;
    };
    struct nodim
    {
...
//typedef typename basis_type::template Context<vm::POINT, basis_type, gm_type, geoelement_type, pts_gmc_type::context> basis_context_type;
...
#else
    static const size_type basis_context_value = ( basis_0_type::is_product && nComponents > 1 ) ? vm::POINT | vm::GRAD | vm::JACOBIAN | vm::KB : vm::POINT | vm::GRAD | vm::JACOBIAN | vm::HESSIAN | vm::KB;
    typedef typename mpl::if_<mpl::bool_<is_composite>,
                              mpl::identity<mpl::void_>,
    ...
    template <int i>
    using sub_functionspace_type = typename sub_functionspace<i>::type;
    template <int i>
    using sub_functionspace_ptrtype = typename sub_functionspace<i>::ptrtype;
    /**
       @name Subclasses
    */
    //@{
        ...
        public std::map<int, basis_context_ptrtype>
    {
      public:
        ...
        Context( functionspace_ptrtype Xh )
            : M_Xh( Xh ) {}
        virtual ~Context() {}
    ...
    class Element
        : public Cont,
          ...
          FunctionSpaceBase::ElementBase,
          basis_0_type::polyset_type
    {
      public:
        typedef T value_type;
        ...
        template <int i>
        using sub_element_ptrtype = typename mpl::at_c<element_vector_type, i>::type::second_type;
        template <int i>
        using sub_element_type = typename mpl::at_c<element_vector_type, i>::type::second_type::element_type;
        ...
        Element<T, Cont> sqrt() const
        {
            ...
            for ( int i = 0; i < _e.nLocalDof(); ++i )
                _e( i ) = math::sqrt( this->operator()( i ) );
        ...
        Element<T, Cont> pow( int n ) const
        {
            ...
            for ( int i = 0; i < _e.nLocalDof(); ++i )
                _e( i ) = math::pow( this->operator()( i ), n );
        ...
        typename p0_space_type::element_type extremeValue( boost::shared_ptr<p0_space_type> const& P0h, std::string extreme )
        {
            ...
            FEELPP_ASSERT( P0h->mesh() == this->mesh() )
                .error( "mesh is not the same" );
            FEELPP_ASSERT( is_scalar )
                .error( "only works for scalar fields" );
        ...
        */
        ...
        BOOST_PARAMETER_MEMBER_FUNCTION( (void),
                                         save,
                                         tag,
                                         ( required( path, * ) )( optional( type, ( std::string ), std::string( "binary" ) )( suffix, ( std::string ), std::string( "" ) )( sep, ( std::string ), std::string( "" ) ) ) )
        {
        ...
        BOOST_PARAMETER_MEMBER_FUNCTION( (void),
                                         ...
                                         ( optional( prefix, ( std::string ), "" )( geomap, *, GeomapStrategyType::GEOMAP_OPT )( accumulate, *(boost::is_integral<mpl::_>), false )( verbose, (bool), boption( _prefix = prefix, _name = "on.verbose" ) ) ) )
        {
...
/**
    ...
    BOOST_PARAMETER_MEMBER_FUNCTION( ( pointer_type ),
                                     static New,
                                     tag,
                                     ( required( mesh, * ) )( optional( worldscomm, *, Environment::worldsComm( nSpaces ) )( components, ( size_type ), MESH_RENUMBER | MESH_CHECK )( periodicity, *, periodicity_type() )( extended_doftable, *, std::vector<bool>( nSpaces, false ) ) ) )
    {
  ...
  private:
    ...
    class ComponentSpace
    {
      public:
        ...
        {
            FEELPP_ASSERT( 0 )
                .error( "invalid call for component space extraction" );
            //return M_functionspace;
...
template <typename A0, typename A1, typename A2, typename A3, typename A4>
void FunctionSpace<A0, A1, A2, A3, A4>::init( mesh_ptrtype const& __m,
                                              size_type mesh_components,
                                              periodicity_type const& periodicity,
                                              std::vector<Dof> const& dofindices,
                                              mpl::bool_<false> )
...
template <typename A0, typename A1, typename A2, typename A3, typename A4>
void FunctionSpace<A0, A1, A2, A3, A4>::initList()
{
    if ( !M_worldComm )
...
template <typename A0, typename A1, typename A2, typename A3, typename A4>
template <typename FSpaceHead>
void FunctionSpace<A0, A1, A2, A3, A4>::initHead( FSpaceHead& head )
{
...
template <typename A0, typename A1, typename A2, typename A3, typename A4>
template <typename FSpaceHead, typename... FSpaceTail>
void FunctionSpace<A0, A1, A2, A3, A4>::initList( FSpaceHead& head, FSpaceTail... tail )
{
    initHead( head );
    initList( tail... );
}
...
template <typename A0, typename A1, typename A2, typename A3, typename A4>
void FunctionSpace<A0, A1, A2, A3, A4>::buildComponentSpace() const
{
...
template <typename A0, typename A1, typename A2, typename A3, typename A4>
void FunctionSpace<A0, A1, A2, A3, A4>::updateRegionTree() const
{
...
template <typename A0, typename A1, typename A2, typename A3, typename A4>
bool FunctionSpace<A0, A1, A2, A3, A4>::findPoint( node_type const& pt, size_type& cv, node_type& ptr ) const
{
    if ( !hasRegionTree() )
        regionTree();
