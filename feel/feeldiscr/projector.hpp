 ...
 */
template <class DomainSpace, class DualImageSpace>
class Projector : public OperatorLinear<typename mpl::if_<is_shared_ptr<DomainSpace>,
                                                          mpl::identity<typename DomainSpace::element_type>,
                                                          mpl::identity<DomainSpace>>::type::type,
                                        typename mpl::if_<is_shared_ptr<DualImageSpace>,
                                                          mpl::identity<typename DualImageSpace::element_type>,
                                                          mpl::identity<DualImageSpace>>::type::type>

{
  ...
  public:
     ...
     */
    //@{
    typedef OperatorLinear<typename mpl::if_<is_shared_ptr<DomainSpace>,
                                             mpl::identity<typename DomainSpace::element_type>,
                                             mpl::identity<DomainSpace>>::type::type,
                           typename mpl::if_<is_shared_ptr<DualImageSpace>,
                                             mpl::identity<typename DualImageSpace::element_type>,
    ...
    domain_element_type
    projectL2( RangeT range, ExprT expr )
    {
    ...
    BOOST_PARAMETER_MEMBER_FUNCTION( ( domain_element_type ),
                                     project,
                                     tag,
                                     ( required( expr, * ) )( optional( range, *, elements( this->dualImageSpace()->mesh() ) )( quad, *, ( typename integrate_type<Args, decltype( elements( this->dualImageSpace()->mesh() ) )>::_quad_type() ) )( quad1, *, ( typename integrate_type<Args, decltype( elements( this->dualImageSpace()->mesh() ) )>::_quad1_type() ) )( geomap, *, ( integrate_type<Args, decltype( elements( this->dualImageSpace()->mesh() ) )>::geoOrder > 1 ) ? GeomapStrategyType::GEOMAP_OPT : GeomapStrategyType::GEOMAP_HO )( grad_expr, *, ( vf::zero<domain_space_type::nComponents, domain_space_type::nDim>() ) )( div_expr, *, cst( 0. ) )( curl_expr, *, ( vf::zero<mpl::if_<mpl::equal_to<mpl::int_<domain_space_type::nComponents>, mpl::int_<1>>,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             mpl::int_<1>, mpl::int_<domain_space_type::nDim>>::type::value,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    1>() ) ) ) )
    {
        using namespace vf;
            ...
            if ( M_dir == WEAK )
            {
                bilinearForm +=
                    integrate( _range = range, _expr =
                                                   ( -trans( id( this->dualImageSpace()->element() ) ) * gradt( this->domainSpace()->element() ) * vf::N() - trans( idt( this->domainSpace()->element() ) ) * grad( this->dualImageSpace()->element() ) * vf::N() + M_gamma * trans( idt( this->domainSpace()->element() ) )    /*trial*/
...
BOOST_PARAMETER_FUNCTION( ( typename Feel::detail::projector_args<Args>::return_type ),
                          opProjection,
                          tag,
                          ( required( domainSpace, *(boost::is_convertible<mpl::_, boost::shared_ptr<FunctionSpaceBase>>))( imageSpace, *(boost::is_convertible<mpl::_, boost::shared_ptr<FunctionSpaceBase>>)) )( optional( type, ( ProjectorType ), L2 )( penaldir, *(boost::is_arithmetic<mpl::_>), 20. )( backend, *, Backend<double>::build( soption( _name = "backend" ) ) ) ) )
{
...
BOOST_PARAMETER_FUNCTION( ( typename Feel::detail::lift_args<Args>::lift_return_type ),
                          opLift,
                          tag,
                          ( required( domainSpace, *(boost::is_convertible<mpl::_, boost::shared_ptr<FunctionSpaceBase>>)) )( optional( type, ( DirichletType ), WEAK )( penaldir, *(boost::is_arithmetic<mpl::_>), 20. )( backend, *, Backend<double>::build( soption( _name = "backend" ) ) ) ) )
{
