...
#include <feel/feeldiscr/mesh_localization_impl.hpp>
...
BOOST_PP_LIST_FOR_EACH_PRODUCT( FACTORY_SIMPLEX_OP_E, 3, ( DIMS3, ORDERS3, RDIMS3 ) )
BOOST_PP_LIST_FOR_EACH_PRODUCT( FACTORY_HYPERCUBE_OP_E, 3, ( DIMS3, ORDERS3, RDIMS3 ) )
