...
class ReducedBasisSpace : public ModelType::functionspace_type
{
  ...
  public:
    ...
    class Element
        : public Cont,
          boost::addable<Element<T, Cont>>,
          boost::subtractable<Element<T, Cont>>
    {
      public:
        typedef ReducedBasisSpace<ModelType> rbspace_type;
        typedef boost::shared_ptr<rbspace_type> rbspace_ptrtype;
        ...
        {
            int size = super::size();
            FEELPP_ASSERT( index < size )
            ( index )( size ).error( "invalid index" );
        ...
        Element& operator+=( Element const& _e )
        {
            ...
            int size2 = _e.size();
            FEELPP_ASSERT( size1 == size2 )
            ( size1 )( size2 ).error( "invalid size" );
        ...
        template <typename Context_t>
        void id_( Context_t const& context, id_array_type& v ) const;
        template <typename Context_t>
        void id_( Context_t const& context, id_array_type& v, mpl::bool_<true> ) const;
        template <typename Context_t>
        void id_( Context_t const& context, id_array_type& v, mpl::bool_<false> ) const;
        ...
        template <typename Context_t>
        void grad_( Context_t const& context, grad_array_type& v ) const;
        template <typename Context_t>
        void grad_( Context_t const& context, grad_array_type& v, mpl::bool_<true> ) const;
        template <typename Context_t>
        void grad_( Context_t const& context, grad_array_type& v, mpl::bool_<false> ) const;
        ...
        template <typename Context_t>
        void d_( int N, Context_t const& context, id_array_type& v ) const;
        template <typename Context_t>
        void d_( int N, Context_t const& context, id_array_type& v, mpl::bool_<true> ) const;
        template <typename Context_t>
        void d_( int N, Context_t const& context, id_array_type& v, mpl::bool_<false> ) const;
    ...
    space_element_type expansion( element_type const& unknown, int N = -1 )
    {
        ...
        if ( N == -1 )
            ...
            number_of_coeff = N;
        FEELPP_ASSERT( number_of_coeff <= basis_size )
        ( number_of_coeff )( basis_size ).error( "invalid size" );
...
template <typename Context_t>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::id_( Context_t const& context, id_array_type& v ) const
{
...
template <typename Y, typename Cont>
template <typename Context_t>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::grad_( Context_t const& context, grad_array_type& v ) const
{
...
template <typename Y, typename Cont>
template <typename Context_t>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::d_( int N, Context_t const& context, id_array_type& v ) const
{
...
template <typename Y, typename Cont>
template <typename Context_t>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::id_( Context_t const& context, id_array_type& v, mpl::bool_<true> ) const
{
    v[0] = context.id( *this );
}
...
template <typename Y, typename Cont>
template <typename Context_t>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::grad_( Context_t const& context, grad_array_type& v, mpl::bool_<true> ) const
{
...
template <typename Y, typename Cont>
template <typename Context_t>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::d_( int N, Context_t const& context, id_array_type& v, mpl::bool_<true> ) const
{
    ctxrb_type const& rb_context = dynamic_cast<ctxrb_type const&>( context );
...
template <typename Y, typename Cont>
template <typename Context_t>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::id_( Context_t const& context, id_array_type& v, mpl::bool_<false> ) const
{
...
template <typename Y, typename Cont>
template <typename Context_t>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::grad_( Context_t const& context, grad_array_type& v, mpl::bool_<false> ) const
{
...
template <typename Y, typename Cont>
template <typename Context_t>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::d_( int N, Context_t const& context, id_array_type& v, mpl::bool_<false> ) const
{
...
template <typename ModelType>
template <typename Y, typename Cont>
void ReducedBasisSpace<ModelType>::Element<Y, Cont>::idInterpolate( matrix_node_type __ptsReal, id_array_type& v, bool conformalEval, matrix_node_type const& setPointsConf ) const
{
    bool go = false;
...
template <typename ModelType>
inline boost::shared_ptr<ReducedBasisSpace<ModelType>>
