...
class OperatorLinearComposite : public OperatorLinear<DomainSpace, DualImageSpace>
{
  ...
  public:
    ...
    void sumAllMatrices( matrix_ptrtype& matrix, bool use_scalar_one = false ) const
    {
        ...
        FEELPP_ASSERT( !size_error )
        ( size1 )( size2 ).error( "OperatorLinearComposite has no elements, or both maps have elements" );
    ...
    void sumAllMatrices1( matrix_ptrtype& matrix, bool use_scalar_one = false ) const
    {
        ...
        FEELPP_ASSERT( size1 > 0 )
        ( size1 )( size2 ).error( "OperatorLinearComposite has no elements" );
    ...
    void matrixPtr( int q, matrix_ptrtype& matrix )
    {
        ...
        FEELPP_ASSERT( q < q_max )
        ( q_max )( q ).error( "OperatorLinearComposite has not enough elements" );
        //fill matrix
