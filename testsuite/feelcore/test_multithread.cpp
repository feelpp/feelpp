...
BOOST_AUTO_TEST_CASE(integrate_coarse)
{
    ...
    typedef typename decltype(cst(1.0)) expr_type;
    typedef typename _Q< ExpressionOrder<range_type,expr_type>::value > >::type quad_type;
    typedef typename _Q< ExpressionOrder<range_type,expr_type>::value_1 > >::type quad1_type;
