...
*/
#define BOOST_TEST_MODULE test_elementswithmarkedfaces
...
makeAbout()
{
    AboutData about( "test_elementswithmarkedfaces" ,
                     "test_elementswithmarkedfaces" ,
                     "0.2",
                     "nD(n=2,3) test elementswithmarkedfaces",
...
BOOST_AUTO_TEST_SUITE( elementswithmarkedfaces_suite )
...
BOOST_AUTO_TEST_CASE_TEMPLATE( test_elements, T, dim_t )
{
    ...
    if ( T::value == 3 ) 
        flag=15;
    auto submesh = createSubmesh( _mesh=mesh, _range=elementsWithMarkedFaces(mesh,flag_type(flag)) );
