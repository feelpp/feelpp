...
/**
 * \file
 * \brief Reference tests for SB9 mode-stabilization operators.
 *
 * This file verifies that the four `Bs*` blocks preserve rigid translations
 * and rotations on representative shell patches.
 */
 ...
 *
 * The helper assembles the quadratic form associated with each block and
 * evaluates it on a prescribed rigid field interpolated in the displacement
 * space. The expected row layout is `Bs1,Bs2,Bs3,Bs4 = 1,1,2,3`.
 *
...
/**
 * \test Verify that `Bs1..Bs4` preserve rigid modes on a flat patch.
 */
...
/**
 * \test Verify that `Bs1..Bs4` preserve rigid modes after rotation.
 */
