...
BOOST_AUTO_TEST_CASE( test_hdiv_interpolant_1 )
{
    ...
    std::vector<std::string> mygeoms2d = soption(_name="meshes-2d"); //.template as< std::vector<std::string> >();
    ...
    std::vector<std::string> mygeoms3d = soption(_name="meshes-3d");//.template as< std::vector<std::string> >();
