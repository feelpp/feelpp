...
makeOptions()
{
    ...
    desc_options.add_options()( "hsize", po::value<double>()->default_value( 0.1 ), "mesh size" );
...
void test2dTo1d()
{
    ...
    auto s = integrate( _range = elements( mesh1d ),
                        _expr = inner( idv( u1dinterp ) - idv( u1dproj ), idv( u1dinterp ) - idv( u1dproj ), mpl::int_<InnerProperties::IS_SAME>() ) )
                 .evaluate()( 0, 0 );
...
void test2dTo2d()
{
    ...
    auto s1 = integrate( _range = elements( mesh ),
                         _expr = inner( idv( u1 ), idv( u1 ), mpl::int_<InnerProperties::IS_SAME>() ) )
                  .evaluate()( 0, 0 );
    auto s2 = integrate( _range = elements( mesh ),
                         _expr = inner( idv( u2 ), idv( u2 ), mpl::int_<InnerProperties::IS_SAME>() ) )
                  .evaluate()( 0, 0 );
    ...
    auto s2a = integrate( _range = boundaryfaces( mesh ),
                          _expr = inner( idv( u1 ) - idv( u2a ), idv( u1 ) - idv( u2a ), mpl::int_<InnerProperties::IS_SAME>() ) )
                   .evaluate()( 0, 0 );
...
void testSMD( double tol )
{
    ...
    double s2a = integrate( _range = elements( submesh ),
                            _expr = inner( idv( u2 ) - idv( u1Base ), idv( u2 ) - idv( u1Base ), mpl::int_<InnerProperties::IS_SAME>() ) )
                     .evaluate()( 0, 0 );
    ...
    double s2c = integrate( _range = elements( submesh ),
                            _expr = inner( idv( u2 ) - idv( u2Base ), idv( u2 ) - idv( u2Base ), mpl::int_<InnerProperties::IS_SAME>() ) )
                     .evaluate()( 0, 0 );
