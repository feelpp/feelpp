...
//
int Nstep = 1;
const Life::uint16_type gtOrder = 1;
...
makeOptions()
{
    Life::po::options_description testoptions("test convergence options");
    testoptions.add_options()
        ("hsize", Life::po::value<double>()->default_value( 0.5 ), "first h value to start convergence")
        ("nmesh", Life::po::value<int>()->default_value( 3 ), "number of meshes to build ")
    ...
    solveroptions.add_options()
        ("verbose", Life::po::value<int>()->default_value( 0 ), "(=0,1,2) print solver iterations")
        ("maxiter", Life::po::value<int>()->default_value( 1000 ), "set maximum number of iterations")
        ;
...
makeAbout()
{
    Life::AboutData about( "test_convergence" ,
                            "test_convergence" ,
                            "0.1",
...
public:
    ...
    {
        Debug() << "[TestConvergence] hsize = " << initialMeshSize << "\n";
