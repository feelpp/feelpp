...
BOOST_AUTO_TEST_CASE( test_1d_kdtree )
{
    ...
    KDTree::node_type p1(1);p1(0)=0.314;
    //the solution
    KDTree::node_type p11(1);p11(0)=0.31;
    KDTree::node_type p12(1);p12(0)=0.32;
     ...
     * case 2 :
     *********************/
    KDTree::node_type p2(1);p2(0)=1.81;

    KDTree::node_type p21(1);p21(0)=1.80;
    KDTree::node_type p22(1);p22(0)=1.82;
...
BOOST_AUTO_TEST_CASE( test_2d_kdtree )
{
    ...
    //the point of research
    KDTree::node_type p1(2);p1(0)=0.43;p1(1)=1.32;
    //the solution
    KDTree::node_type p11(2);p11(0)=0.4;p11(1)=1.3;
    KDTree::node_type p12(2);p12(0)=0.5;p12(1)=1.3;
    KDTree::node_type p13(2);p13(0)=0.4;p13(1)=1.4;
    KDTree::node_type p14(2);p14(0)=0.5;p14(1)=1.4;
     ...
     * case 2 :
     *********************/
    KDTree::node_type p2(2);p2(0)=0.8;p2(1)=0.2;

    KDTree::node_type p21(2);p21(0)=0.8;p21(1)=0.1;
    KDTree::node_type p22(2);p22(0)=0.8;p22(1)=0.3;
    KDTree::node_type p23(2);p23(0)=0.7;p23(1)=0.2;
    KDTree::node_type p24(2);p24(0)=0.9;p24(1)=0.2;
...
BOOST_AUTO_TEST_CASE( test_3d_kdtree )
{
    ...
    //the point of research
    KDTree::node_type p1(3);p1(0)=0.43;p1(1)=1.32;p1(2)=1.835;

    //the solution
    KDTree::node_type p11(3);p11(0)=0.4;p11(1)=1.3;p11(2)=1.8;
    KDTree::node_type p12(3);p12(0)=0.5;p12(1)=1.3;p12(2)=1.8;
    KDTree::node_type p13(3);p13(0)=0.4;p13(1)=1.4;p13(2)=1.8;
    KDTree::node_type p14(3);p14(0)=0.5;p14(1)=1.4;p14(2)=1.8;
    KDTree::node_type p15(3);p15(0)=0.4;p15(1)=1.3;p15(2)=1.9;
    KDTree::node_type p16(3);p16(0)=0.5;p16(1)=1.3;p16(2)=1.9;
    KDTree::node_type p17(3);p17(0)=0.4;p17(1)=1.4;p17(2)=1.9;
    KDTree::node_type p18(3);p18(0)=0.5;p18(1)=1.4;p18(2)=1.9;
    ...
    KDTree::node_type p2(3);p2(0)=0.9;p2(1)=1.4;p2(2)=1.0;
    //the solution
    KDTree::node_type p21(3);p21(0)=0.9;p21(1)=1.3;p21(2)=1.0;
    KDTree::node_type p22(3);p22(0)=0.9;p22(1)=1.5;p22(2)=1.0;
    KDTree::node_type p23(3);p23(0)=0.8;p23(1)=1.4;p23(2)=1.0;
    KDTree::node_type p24(3);p24(0)=1.0;p24(1)=1.4;p24(2)=1.0;
    KDTree::node_type p25(3);p25(0)=0.9;p25(1)=1.4;p25(2)=1.1;
    KDTree::node_type p26(3);p26(0)=0.9;p26(1)=1.4;p26(2)=0.9;
