...
struct test_mesh_filters
{
    ...
    void operator()()
    {
        ...
        // location faces
        {
            Life::MeshTraits<detail::mesh_type>::location_face_const_iterator it = mesh->beginInternalFace();
            Life::MeshTraits<detail::mesh_type>::location_face_const_iterator en = mesh->endInternalFace();
