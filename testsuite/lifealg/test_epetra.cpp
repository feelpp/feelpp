...
public:
  ...
  void run()
  {
    ...
    Life::MatrixEpetra A(RowMap, 3);
    Life::MatrixEpetra B(6,4,3,2,2,0);
    Life::MatrixEpetra C(RowMap,ColMap);
    Life::MatrixEpetra D(RowMap1,ColMap1);
...
init_unit_test_suite( int argc, char** argv )
{
    ...
    Life::MyEpetraApp myapp(argc, argv, Life::makeAbout() );
