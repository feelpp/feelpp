...
BOOST_AUTO_TEST_CASE( journal_fspace )
{
    tic();
    auto mesh1 = loadMesh( _mesh=new Mesh<Simplex<1,1>>, _name="MyMesh1" );
    auto mesh2 = loadMesh( _mesh=new Mesh<Simplex<2,1>>, _name="MyMesh2" );
