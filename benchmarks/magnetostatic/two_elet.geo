...
p5 = newp; Point(p5) = {0.7,0.7,0.7,h};
...
ll5 = newll; Line Loop(ll5) = {-l6,l8,-l7};
ll6 = newll; Line Loop(ll6) = {l4,l7,-l9};
ll7 = newll; Line Loop(ll7) = {l2,l8,-l9};
...
sl2 = newsl; Surface Loop(sl2) = {s5,s6,s7,s3};
