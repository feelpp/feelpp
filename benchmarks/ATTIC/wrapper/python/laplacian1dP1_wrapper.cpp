 ...
 * call a function (aka NumericalMathFunction) named "laplacian1dP1" (laplacian1dP1 stands
 * for wrapped code).
 * In order to individualize the wrapper to the user's needs, we encourage
 * you (as the developer of this wrapper) to renamed any occurence of "laplacian1dP1"
 * (in either case) to the real name of the function.
 * It will also avoid any confusion with other "laplacian1dP1"s written by other entities
 * or developers.
 */
 ...
 *  - change the current wrapper name 'opuseadscrb' to any name you chooze. Be careful to respect
 ...
 *        First, change the name 'opuseadscrb' everywhere in the macro to the name of your FORTRAN
...
#define WRAPPERNAME laplacian1dP1
...
extern "C" {
    ...
    */
     ...
     * 'init_', 'exec_' and 'finalize_' folowed by the name of the function, here 'laplacian1dP1'.
     *
