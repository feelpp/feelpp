...
Stokes_Dirichlet_Neumann<POrder,GeoOrder>::Stokes_Dirichlet_Neumann( )
    :
    super( ),
...
template<int POrder, int GeoOrder>
void
Stokes_Dirichlet_Neumann<POrder,GeoOrder>::init()
{
...
template<int POrder, int GeoOrder>
void
Stokes_Dirichlet_Neumann<POrder,GeoOrder>::run()
{
    this->init();
...
template<typename ExprUExact, typename ExprPExact>
void
Stokes_Dirichlet_Neumann<POrder,GeoOrder>::exportResults( ExprUExact u_exact, ExprPExact p_exact,
                       element_type& U, element_type& V )
{
