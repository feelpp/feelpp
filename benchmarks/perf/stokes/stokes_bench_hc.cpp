...
Stokes<Dim, BasisU, BasisP, Entity>::run()
{
    ...
    form2( Xh, Xh, D, _init=true )=integrate( elements( mesh ), mu*( trans( dxt( u ) )*dx( v )+trans( dyt( u ) )*dy( v ) ) ) ;
...
main( int argc, char** argv )
{
    ...
    typedef Feel::Stokes<nDim, CrouzeixRaviart<1, Vectorial,PointSetEquiSpaced>,Lagrange<0, Scalar,Discontinuous>, Hypercube> stokes_type;
