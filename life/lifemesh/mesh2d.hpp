...
#include <life/lifemesh/faces.hpp>
#include <life/lifemesh/points.hpp>
#include <life/lifemesh/functors.hpp>
...
class Mesh2D
    :
        ...
        public Faces<GeoEntity<typename Shape::template shape<1,Shape::nOrder,Shape::nRealDim>::type>,
...
public:
    ...
    typedef Faces<GeoEntity<typename Shape::template shape<1,Shape::nOrder,Shape::nRealDim>::type>,
     ...
     */
    bool isEmpty() const { return ( super_elements::isEmpty() &&
     ...
     * \sa numLocalFaces()
     */
    size_type numLocalEdges() const { return super_elements::element_type::numLocalEdges; }

    /**
     * \return the number of faces in an element
     * \sa numLocalEdges()
     */
    size_type numLocalFaces() const { return super_elements::element_type::numLocalEdges; }
     ...
     */
    size_type numEdges() const { return this->faces().size(); }
...
protected:
     ...
     * \see Mesh
     */
    void renumber() { LIFE_ASSERT( 0 ).error( "invalid call" ); }
