/* -*- mode: c++ -*-
  ...
  This file is part of the Life Imaging project.
...
public:
    ...
    /**
     */
    size_type numElements() const { return _M_coord.num_elements(); }
     ...
     * @return
     */
    shape_type const& shape() const { return _M_shape; }
     ...
     * @return
     */
    uint extent( uint __i ) const { return _M_shape[__i]; }
