...
solvereigen_options( std::string const& prefix )
{
    ...
    _options.add_options()
        // solver options
        ((_prefix+"solvereigen-solver-type").c_str(), Life::po::value<int>()->default_value( KRYLOVSCHUR ), "type of eigenvalue solver")
        ((_prefix+"solvereigen-problem-type").c_str(), Life::po::value<int>()->default_value( NHEP ), "type of eigenvalue problem")
        ((_prefix+"solvereigen-position").c_str(), Life::po::value<int>()->default_value( LARGEST_MAGNITUDE ), "eigenvalue solver position in spectrum")
        ((_prefix+"solvereigen-nev").c_str(), Life::po::value<int>()->default_value( 1 ), "number of requested eigenpairs")
        ((_prefix+"solvereigen-ncv").c_str(), Life::po::value<int>()->default_value( 3 ), "number of basis vectors")
        ((_prefix+"solvereigen-tol").c_str(), Life::po::value<double>()->default_value( 1e-10 ), "solver tolerance")
        ((_prefix+"solvereigen-maxiter").c_str(), Life::po::value<int>()->default_value( 1000 ), "maximum number of iterations");
