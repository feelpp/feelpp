                                ...
                                graph_ptrtype const& graph )
{
    ...
    Life::detail::ignore_unused_variable_warning(n);
    Life::detail::ignore_unused_variable_warning(m_l);
    Life::detail::ignore_unused_variable_warning(n_l);
    Life::detail::ignore_unused_variable_warning(graph);
...
MatrixGmm<T, LayoutType>::addMatrix(value_type v, MatrixSparse<value_type>& _m )
{
    ...
    LIFE_ASSERT( m != 0 ).error( "invalid sparse matrix type, should be MatrixGmm" );
    LIFE_ASSERT( m->closed() ).error( "invalid sparse matrix type, should be closed" );
    if ( !m )
