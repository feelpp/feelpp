...
#include <life/lifeopt/problem.hpp>
#include <life/lifeopt/dirscalingmatrix.hpp>
...
public:
	...
	*/
	...
	public:
        ...
        bool collectStats() const { return _M_collect; }
    ...
    statistics_type const& stats() const { return _M_solver_stats; }

    problem_type& problem() { return _M_prob; }
...
{
	norm_Tgrad_fx_hstr.clear(); norm_err.clear();
	n_CGiter_hstr.clear(); n_restarts_hstr.clear();
	n_indef_hstr.clear(); n_crosses_def_hstr.clear(); n_crosses_indef_hstr.clear();
	n_truss_exit_def_hstr.clear(); n_truss_exit_indef_hstr.clear();
	Delta_hstr.clear(); ared_til_hstr.clear(); phi_til_hstr.clear(); rho_hstr.clear();
}
template<typename Data, template<class> class Problem>
void
                                                 ...
                                                 value_type rho )
{
	...
	n_CGiter_hstr.push_back( n_CGiter ); n_restarts_hstr.push_back( n_restarts );
	n_indef_hstr.push_back( n_indef ); n_crosses_def_hstr.push_back( n_crosses_def );
	...
	Delta_hstr.push_back( Delta ); ared_til_hstr.push_back( ared_til );
	phi_til_hstr.push_back( phi_til ); rho_hstr.push_back( rho );
}
