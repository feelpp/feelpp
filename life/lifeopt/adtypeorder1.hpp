...
public:
    ...
    deps_type deps() const { return __dep; }
...
template <
    ...
    >
Life::DebugStream&
operator << ( Life::DebugStream& __os, const Life::ADType<T, Nvar, 1, Var>& a )
{
...
std::ostream&
operator << ( std::ostream& os, const Life::ADType<T, Nvar, 1, Var>& a)
{
