...
private:
    ...
    {
        LIFE_ASSERT( face_perm != face_permutation_type( face_permutation_type::NO_PERMUTATION ) )
        ...
        LIFE_ASSERT( res.size1() == Gt.size1() &&
    ...
    {
        LIFE_ASSERT(P.size1() == P.size2()).error("invalid permutation");
