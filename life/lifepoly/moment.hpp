...
public:
  ...
  typedef Moment<Dim, Degree,/* NormalizationPolicy,*/ T, StoragePolicy> self_type;
     ...
     */
    typedef Simplex<nDim, nConvexOrder, nDim> convex_type;
    ...
    ublas::matrix<int16_type> coord(){return _M_coord;}
...
typename Moment<Dim, Degree,/* NormalizationPolicy,*/ T, StoragePolicy>::matrix_type
Moment<Dim, Degree,/* NormalizationPolicy,*/ T, StoragePolicy>::evaluate( points_type const& __pts, mpl::int_<2> ) const
{
...
template<uint16_type Dim,
	...
	//         typename NormalizationPolicy,
         ...
         template<class> class StoragePolicy>
template<typename AE>
typename Moment<Dim, Degree,/* NormalizationPolicy,*/ T, StoragePolicy>::vector_matrix_type
Moment<Dim, Degree,/* NormalizationPolicy,*/ T, StoragePolicy>::derivate( ublas::matrix_expression<AE> const& __pts, mpl::int_<2> ) const
{
...
template<uint16_type Dim,
	...
	//         typename NormalizationPolicy,
         ...
         template<class> class StoragePolicy>
typename Moment<Dim, Degree,/* NormalizationPolicy,*/ T, StoragePolicy>::matrix_type
Moment<Dim, Degree, /*NormalizationPolicy, */T, StoragePolicy>::evaluate( points_type const& __pts, mpl::int_<3> ) const
{
    matrix_type res( convex_type::polyDims( nOrder ), __pts.size2() );

    LIFE_ASSERT( __pts.size1() == 3 )( __pts.size1() ).error( "invalid space dimension" );
...
template<typename AE>
typename Moment<Dim, Degree,/* NormalizationPolicy,*/ T, StoragePolicy>::vector_matrix_type
Moment<Dim, Degree,/* NormalizationPolicy,*/ T, StoragePolicy>::derivate( ublas::matrix_expression<AE> const& __pts, mpl::int_<3> ) const
{
