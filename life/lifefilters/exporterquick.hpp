...
/**
   ...
   \date 2008-02-21
 */
#ifndef __LIFE_EXPORTERQUICK_HPP__
#define __LIFE_EXPORTERQUICK_HPP__ 1
...
public:
    ...
    void save( mesh_ptrtype const& mesh )
    {
        if ( !mesh )
            {
                LIFE_ASSERT( mesh ).error( "[ExporterQuick] invalid mesh (=0)" );
                return;
            }
...
#endif // __LIFE_EXPORTERQUICK_HPP__
