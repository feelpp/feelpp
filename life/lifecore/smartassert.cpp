...
void initAssert()
{
    ::Life::Assert::setLog( &::Life::SmartAssert::defaultLogger);
    ::Life::Assert::setHandler( lvl_warn, &::Life::SmartAssert::defaultWarnHandler);
    ::Life::Assert::setHandler( lvl_debug, &::Life::SmartAssert::defaultDebugHandler);
    ::Life::Assert::setHandler( lvl_error, &::Life::SmartAssert::defaultErrorHandler);
    ::Life::Assert::setHandler( lvl_fatal, &::Life::SmartAssert::defaultFatalHandler);
}
