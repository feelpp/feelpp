...
public:
     ...
     *        This defaults to the life-dev@webmail.polimi.it mailing list.
     *
     */
    AboutData( const char* appName,
               ...
               const char* bugsEmailAddress = "life-dev@webmail.polimi.it"
               );
     ...
     *        Start the address with "http://". "http://www.life.org" is
     *        is correct, "www.life.org" is not.
     */
     ...
     *        This defaults to the life-dev@ mailing list.
     */
