...
public:
    ...
    bool registerProduct( const identifier_type& id, creator_type creator )
        {
            Life::Debug( 2200 ) << "Registered type with id : " << id << "\n";
    ...
    bool unregisterProduct( const identifier_type& id )
        {
            Life::Debug( 2200 ) << "Unregistered type with id : " << id << "\n";
    ...
    product_type* createObject( const identifier_type& id )
        {
            ...
            {
                Life::Debug ( 2200 ) << "Creating type with id : " << id << "\n";
                return (i->second)();
            }
            Life::Debug( 2200 ) << "Unknown type with id : " << id << "\n";
