...
// Simplex 1,1
//
typedef Mesh<GeoEntity<Simplex<1,1,1> > > meshs11_t;
...
// Simplex 2,1
//
typedef Mesh<GeoEntity<Simplex<2,1,2> > > meshs21_t;
...
typedef Mesh<GeoEntity<Simplex<2,2,2> > > meshs22_t;
...
typedef Mesh<GeoEntity<Simplex<2,3,2> > > meshs23_t;
...
typedef Mesh<GeoEntity<Simplex<2,4,2> > > meshs24_t;
...
typedef Mesh<GeoEntity<Simplex<2,5,2> > > meshs25_t;
...
// Simplex 3,1
//
typedef Mesh<GeoEntity<Simplex<3,1,3> > > meshs31_t;
...
typedef Mesh<GeoEntity<Simplex<3,2,3> > > meshs32_t;
...
// SimplexProduct 1,1
//
typedef Mesh<GeoEntity<SimplexProduct<1,1,1> > > meshsp11_t;
...
// SimplexProduct 2,1
//
typedef Mesh<GeoEntity<SimplexProduct<2,1,2> > > meshsp21_t;
...
// SimplexProduct 3,1
//
typedef Mesh<GeoEntity<SimplexProduct<3,1,3> > > meshsp31_t;
...
//
// 1D
template class Partitioner<Mesh<GeoEntity<Simplex<1,1,1> > > >;
// 1D2D
