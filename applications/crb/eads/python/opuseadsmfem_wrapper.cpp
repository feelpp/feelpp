 ...
 *  - change the current wrapper name 'opuseadsmfem' to any name you chooze. Be careful to respect
 ...
 *        First, change the name 'opuseadsmfem' everywhere in the macro to the name of your FORTRAN
...
#define WRAPPERNAME opuseadsmfem
...
extern "C" {
    ...
    */
    ...
    FUNC_CREATESTATE( WRAPPERNAME ,
    {
        ...
        *p_p_state = new Feel::EadsMFemApp( Feel::makeEadsAbout( "eadsmfem" ),
    ...
    {
        delete CAST( Feel::EadsMFemApp*, p_state );
    } )
     ...
     * 'init_', 'exec_' and 'finalize_' folowed by the name of the function, here 'opuseadsmfem'.
     *
