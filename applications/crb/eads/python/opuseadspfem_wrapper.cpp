 ...
 *  - change the current wrapper name 'opuseadspfem' to any name you chooze. Be careful to respect
 ...
 *        First, change the name 'opuseadspfem' everywhere in the macro to the name of your FORTRAN
...
#define WRAPPERNAME opuseadspfem
...
*/
     ...
     * 'init_', 'exec_' and 'finalize_' folowed by the name of the function, here 'opuseadspfem'.
     *
    ...
    FUNC_EXEC( WRAPPERNAME,
               {
                   OPUS_FUNC_EXEC_BODY_IN_TEMPDIR( Feel::PFemApp<Feel::opusmodel212_type>, WRAPPERNAME  )
               } )
