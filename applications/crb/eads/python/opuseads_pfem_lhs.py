...
f_param = open('plhsK.dat', 'r')
s_pfem_Kic = open("output_plhs_pfem_Kic_py.txt", "w")
s_pfem_D = open("output_plhs_pfem_D_py.txt", "w")
s_pfem_r = open("output_plhs_pfem_r_py.txt", "w")
s_pfem_ea = open("output_plhs_pfem_ea_py.txt", "w")
s_pfem_all = open("output_plhs_pfem_all_py.txt", "w")
print "-------------------------------------------\n"
