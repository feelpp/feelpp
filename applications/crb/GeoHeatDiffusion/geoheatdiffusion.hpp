 ...
 * @see
 */
class GeoHeatDiffusion : public CRBModelBase< ParameterSpace<3>, FunctionSpaceDefinition >
{
public:
...
void GeoHeatDiffusion::initModel()
{
    ...
    auto mesh = R.createMesh( _mesh=new mesh_type, _name="Omega" );
...
double GeoHeatDiffusion::output( int output_index, parameter_type const& mu, element_type &u, bool need_to_solve , bool export_outputs )
{
    ...
    if ( output_index == 0 )
        ...
        output = integrate( elements( mesh ), idv( u )/mu(0) ).evaluate()( 0,0 );
