...
from ..context import DebianPackagingContext
...
def debian_context_from_args(args: argparse.Namespace) -> DebianPackagingContext:
    return DebianPackagingContext.create(
...
def context_from_args(args: argparse.Namespace) -> DebianPackagingContext:
    return debian_context_from_args(args)
...
def load_plan(args: argparse.Namespace, context: DebianPackagingContext):
