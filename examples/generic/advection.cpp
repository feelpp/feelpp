...
makeOptions()
{
    Life::po::options_description advectionoptions("Advection options");
...
//        ("g", Life::po::value<double>()->default_value( 0 ), "boundary term")
        ...
        ("stiff", Life::po::value<double>()->default_value( 1.0 ), "stiffness parameter of solution")
        ("ring", Life::po::value<bool>()->default_value( 0 ), "0 = square computational domain, 1 = quarter of a ring as computational domain")
        ...
        ;
    return advectionoptions.add( Life::life_options() ) ;
}
inline
Life::AboutData
makeAbout()
{
    Life::AboutData about( "advection" ,
                            "advection" ,
                            "0.2",
    ...
    main( int argc, char** argv )
{
    ...
    typedef Life::Advection<nDim, nOrder, MyContinuity, SimplexProduct> advection_type;

    /* assertions handling */
    Life::Assert::setLog( "advection.assert");
