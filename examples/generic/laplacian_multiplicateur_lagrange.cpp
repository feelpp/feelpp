...
makeOptions()
{
    Life::po::options_description laplacian_mloptions("LaplacianML options");
...
makeAbout()
{
    Life::AboutData about( "laplacian_ml" ,
                           "laplacian_ml" ,
                           "0.1",
...
main( int argc, char** argv )
{
    ...
    typedef Life::LaplacianML<nDim, nOrder> laplacian_ml_type;
