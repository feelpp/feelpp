...
|===
| Platform & Compiler | `master` | `develop` | `feature/hdg-sc`
...
| image:https://travis-ci.org/feelpp/feelpp.svg?branch=feature/hdg-c["Build Status", link="https://travis-ci.org/feelpp/feelpp"]
...
image::https://media.githubusercontent.com/media/feelpp/book.feelpp.org/master/images/cover_small.jpg[caption="{feelpp} Book",link=http://book.feelpp.org]
