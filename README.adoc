...
link:http://www.feelpp.org[Feel\+1] is a C\+1 library for arbitrary order Galerkin methods (e.g. finite and spectral element methods) continuous or discontinuous in 1D 2D and 3D. The objectives of this framework is quite ambitious; ambitions which could be express in various ways such as :
  ...
  - the creation of a library entirely in C\+1 allowing to create C\+1 complex and typically multi-physics applications such as fluid-structure interaction or mass transport in haemodynamic.
...
Here are the latest releases of Feel\+1
...
== Documentation
  ...
  - develop branch : [Feel\+1 Online Reference Manual](http://www.feelpp.org/docs/develop/index.html)
  - master branch (latest release) : [Feel\+1 Online Reference Manual](http://www.feelpp.org/docs/master/index.html)
...
== Features
  ...
  - domain specific embedded language in C\+1 for variational formulations
