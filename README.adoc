...
image::https://media.githubusercontent.com/media/feelpp/book.feelpp.org/master/images/cover_small.jpg[caption="{feelpp} Book",link=http://book.feelpp.org,float=right]
