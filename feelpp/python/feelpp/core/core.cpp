...
PYBIND11_MODULE(_core, m )
{
    ...
    py::class_<Repository>( m, "Repository" )
        ...
        .def( "configure", static_cast<Repository& (Repository::*)()>(&Repository::configure), "configure the repository", py::return_value_policy::reference_internal )
        .def( "configure", static_cast<Repository& (Repository::*)(nl::json const&)>(&Repository::configure), "configure the repository from JSON", py::arg( "json" ), py::return_value_policy::reference_internal )
        .def( "configure", static_cast<Repository& (Repository::*)(fs::path const&, Location const&)>(&Repository::configure), "configure the repository from a directory and location", py::arg( "directory" ), py::arg( "location" ), py::return_value_policy::reference_internal )
        .def( "configure", static_cast<Repository& (Repository::*)(fs::path const&)>(&Repository::configure), "configure the repository from a directory", py::arg( "directory" ), py::return_value_policy::reference_internal )
