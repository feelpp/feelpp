...
# Only try toolboxes from the same base tree as feelpp.core to avoid ABI mismatches.
try:
    core_dir = os.path.dirname(fppc.__file__)
    feelpp_dir = os.path.abspath(os.path.join(core_dir, os.pardir))
    toolboxes_dir = os.path.join(feelpp_dir, "toolboxes")
    if os.path.isdir(toolboxes_dir):
