...
Point(1) = {0, 0, -0.1, 1};
Point(2) = {10.0, 0, -0.1, 1};
Point(3) = {0, 10.0, -0.1, 1};
Point(4) = {10.0, 10.0, -0.1, 1};
Point(5) = {0, 0, 0.1, 1};
Point(6) = {10.0, 0, 0.1, 1};
Point(7) = {0, 10.0, 0.1, 1};
Point(8) = {10.0, 10.0, 0.1, 1};
...
Transfinite Line {1, 3, 5, 7} = 9;
Transfinite Line {2, 4, 6, 8} = 9;
