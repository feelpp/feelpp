...
Point(1) = {0, 0, -0.5, 1};
Point(2) = {24.0, 0, -0.5, 1};
Point(3) = {0, 12.0, -0.5, 1};
Point(4) = {24.0, 12.0, -0.5, 1};
Point(5) = {0, 0, 0.5, 1};
Point(6) = {24.0, 0, 0.5, 1};
Point(7) = {0, 12.0, 0.5, 1};
Point(8) = {24.0, 12.0, 0.5, 1};
