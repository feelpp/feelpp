...
//        .def( py::init<std::vector<std::shared_ptr<DataMap<uint32_type>>>, std::shared_ptr<WorldComm>>() )
    ...
    py::class_<MatrixSparse<double>, PyMatrixSparseDouble, std::shared_ptr<MatrixSparse<double>>>( m, "MatrixSparseDouble" )
        ...
        .def( "addMatrix", static_cast<void ( MatrixSparse<double>::* )( double, MatrixSparse<double> const&, Feel::MatrixStructure )>( &MatrixPetsc<double>::addMatrix ), py::arg( "scale" ) = 1.0, py::arg( "matrix" ), py::arg( "structure" ) = Feel::SAME_NONZERO_PATTERN, "add a scaled sparse matrix" )
        ...
        .def( "transpose", static_cast<void ( MatrixSparse<double>::* )( std::shared_ptr<MatrixSparse<double>>&, uint32_type ) const>( &MatrixSparse<double>::transpose ), py::arg( "matrix" ), py::arg( "structure" ) = Feel::SAME_NONZERO_PATTERN, "transpose matrix" )
