...
set( FEELPP_MACHINES_DIR ${FEELPP_SOURCE_DIR}/feelpp/cmake/machines/ )

if ( EXISTS ${FEELPP_MACHINES_DIR}/feelpp.machines.${FEELPP_MACHINE_NAME}.cmake )
...
if( FEELPP_NAME_LOGIN AND EXISTS /lrz )
  if ( EXISTS ${FEELPP_MACHINES_DIR}/feelpp.machines.lrz.cmake )
...
if( FEELPP_NAME_LOGIN AND EXISTS /softs )
  if ( EXISTS ${FEELPP_MACHINES_DIR}/feelpp.machines.rheticus.cmake )
...
if( FEELPP_NAME_LOGIN AND EXISTS /cineca )
  ...
  if ( EXISTS ${FEELPP_MACHINES_DIR}/feelpp.machines.cineca.cmake )
...
if( FEELPP_NAME_LOGIN AND EXISTS /ccc )
  ...
  if ( EXISTS ${FEELPP_MACHINES_DIR}/feelpp.machines.curie.cmake )
...
if( FEELPP_NAME_LOGIN AND EXISTS /bglocal )
  ...
  if ( EXISTS ${FEELPP_MACHINES_DIR}/feelpp.machines.turing.cmake )
...
if( FEELPP_NAME_LOGIN )
  ...
  if ( EXISTS ${FEELPP_MACHINES_DIR}/feelpp.machines.occigen.cmake )
...
STRING(REGEX MATCH "atlas*" FEELPP_NAME_ATLAS ${FEELPP_MACHINE_NAME} )
if( FEELPP_NAME_ATLAS )
  message(STATUS "Using irma-atlas config")
  if ( EXISTS ${FEELPP_MACHINES_DIR}/feelpp.machines.irma-atlas.cmake )
      message( STATUS "[Feel++] Configuration found for : irma-atlas" )
      include( feelpp.machines.irma-atlas )
  endif()
endif()
...
if( FEELPP_NAME_GAYA )
  ...
  if ( EXISTS ${FEELPP_MACHINES_DIR}/feelpp.machines.irma-gaya.cmake )
      message( STATUS "[Feel++] Configuration found for : irma-gaya" )
