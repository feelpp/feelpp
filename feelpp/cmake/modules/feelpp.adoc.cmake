...
if ( ASCIIDOCTOR_FOUND )
  if (DEFINED FEELPP_SOURCE_DIR AND EXISTS "${FEELPP_SOURCE_DIR}/doc/stylesheet.css")
    set (FEELPP_DOCDIR ${FEELPP_SOURCE_DIR}/doc)
  elseif (EXISTS "${CMAKE_SOURCE_DIR}/doc/stylesheet.css")
    set (FEELPP_DOCDIR ${CMAKE_SOURCE_DIR}/doc)
  else()
  ...
  if ( ASCIIDOCTOR_PDF_EXECUTABLE )
    ...
    unset(FEELPP_A2P)
    unset(FEELPP_HAS_ASCIIDOCTOR_PDF)
  endif()
  set (FEELPP_A2M ${ASCIIDOCTOR_EXECUTABLE} -b manpage -amanmanual='${FEELPP_TITLE}')
  set (FEELPP_A2H ${ASCIIDOCTOR_EXECUTABLE} -d manpage -b html5 -a stylesheet=${FEELPP_STYLESHEET} -aversion-label=${PROJECT_NAME} -arevnumber=${FEELPP_PACKAGE_VERSION})
  set (FEELPP_A2M_STR "${ASCIIDOCTOR_EXECUTABLE} -b manpage -amanmanual='${FEELPP_TITLE}'")
  set (FEELPP_A2H_STR "${ASCIIDOCTOR_EXECUTABLE} -d manpage -b html5 -a stylesheet=${FEELPP_STYLESHEET} -aversion-label=${PROJECT_NAME} -arevnumber=${FEELPP_PACKAGE_VERSION}")
