...
if(FEELPP_ENABLE_FFTW)
  ...
  find_package(FFTW COMPONENTS DOUBLE_LIB DOUBLE_MPI_LIB )
  if( FFTW_DOUBLE_LIB_FOUND )
    message(STATUS "[feelpp] FFTW3 double: ${FFTW_LIBRARIES}")
    set(FEELPP_HAS_FFTW_DOUBLE 1)
  endif()
  if( FFTW_DOUBLE_MPI_LIB_FOUND )
    message(STATUS "[feelpp] FFTW3 double mpi: ${FFTW_LIBRARIES}")
    set(FEELPP_HAS_FFTW_DOUBLE_MPI 1)
