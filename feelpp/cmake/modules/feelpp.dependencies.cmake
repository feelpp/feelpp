...
set(Boost_ADDITIONAL_VERSIONS "1.61" "1.62" "1.63" "1.64" "1.65" "1.66" "1.67" "1.68")
...
# VTK
#
option( FEELPP_ENABLE_VTK "Enable VTK Support" OFF ) #${FEELPP_ENABLE_PACKAGE_DEFAULT_OPTION} )
...
if ( FEELPP_ENABLE_LIBCURL )
  ...
  if( CURL_FOUND )
    ...
    set( FEELPP_ENABLED_OPTIONS "${FEELPP_ENABLED_OPTIONS} libcurl/${CURL_VERSION_STRING}" PARENT_SCOPE )
  endif()
endif()
...
foreach( THELIB ${FEELPP_LIBRARIES} )
  if ( TARGET ${THELIB} )
    list(APPEND FEELPP_LIBRARIES_WITH_SPACE  " $<TARGET_FILE:${THELIB}> ")
  else()
...
file( GENERATE OUTPUT ${CMAKE_BINARY_DIR}/feelpp/cmake/modules/feelpp.libraries.config.cmake
...
file( GENERATE OUTPUT ${CMAKE_BINARY_DIR}/feelpp/cmake/modules/feelpp.include.config.cmake
  CONTENT "set(FEELPP_INCLUDE_DIR $<TARGET_PROPERTY:feelpp,INCLUDE_DIRECTORIES>)" )

# write file which contains compile definitions
file( GENERATE OUTPUT ${CMAKE_BINARY_DIR}/feelpp/cmake/modules/feelpp.compile.definition.config.cmake
