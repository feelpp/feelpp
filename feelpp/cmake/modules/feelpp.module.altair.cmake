...
if ( FEELPP_ENABLE_ACUSIM )
  ...
  FIND_PATH(ACUSIM_BASE_DIR include/acusim.h
    ...
    if ( ACUSIM_BASE_DIR )
      ...
      set(ACUSIM_LIBRARIES ${ACUSIM_ADB_LIBRARY} ${ACUSIM_CCI_LIBRARY}  ${ACUSIM_ECO_LIBRARY} ${ACUSIM_FRM_LIBRARY}  ${ACUSIM_H3DREADER_LIBRARY} ${ACUSIM_H3DWRITER_LIBRARY} ${ACUSIM_INTLC_LIBRARY} ${HDF5_LIBRARIES})
