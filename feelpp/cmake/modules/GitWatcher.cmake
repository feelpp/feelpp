...
function(GitStateChangedAction)
    ...
    endforeach()
    message(STATUS "[GitWatcher] generating ${POST_CONFIGURE_FILE} from ${PRE_CONFIGURE_FILE}...")
...
function(SetupGitMonitoring)
    message(STATUS "[GitWatcher] add target check_git...")
    add_custom_target(check_git
        ...
        BYPRODUCTS
            ${POST_CONFIGURE_FILE}
            ${GIT_STATE_FILE}
        COMMENT "[GitWatcher] Checking the git repository for changes..."
        COMMAND
            ${CMAKE_COMMAND}
