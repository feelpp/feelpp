...
macro(feelpp_add_test)
  ...
  if ( NOT FEELPP_TEST_NO_TEST )
      ...
      IF(NOT FEELPP_TEST_NO_MPI_TEST AND NProcs2 GREATER 1)
        ...
        add_test(NAME ${FEELPP_TEST_EXEC}-np-${NProcs2} COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${NProcs2} ${MPIEXEC_PREFLAGS} ${CMAKE_CURRENT_BINARY_DIR}/${targetname} --report_level=detailed --log_level=test_suite ${BOOST_TEST_SEPARATOR} ${MPIEXEC_POSTFLAGS} ${FEELPP_TEST_CFG_CLI} ${FEELPP_TEST_CLI} --directory=testsuite/test_${FEELPP_TEST_NAME} --rm)
        endif()
      ...
      add_test(NAME ${FEELPP_TEST_EXEC}-np-1 COMMAND ${CMAKE_CURRENT_BINARY_DIR}/${targetname} --report_level=detailed --log_level=test_suite ${BOOST_TEST_SEPARATOR} ${FEELPP_TEST_CFG_CLI} ${FEELPP_TEST_CLI} --directory=testsuite/test_${FEELPP_TEST_NAME} --rm)
      endif()
