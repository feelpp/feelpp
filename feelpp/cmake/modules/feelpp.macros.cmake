...
function(feelpp_append_solver_runtime_env TEST_NAME)
  ...
  if(FEELPP_MPI_TEST_ENVIRONMENT)
    list(APPEND _feelpp_solver_runtime_env ${FEELPP_MPI_TEST_ENVIRONMENT})
  endif()
  if(PETSC_DIR)
...
macro(feelpp_add_test)
  ...
  if ( NOT FEELPP_TEST_NO_TEST )
      ...
      if ( FEELPP_TEST_SKIP_TEST OR FEELPP_TEST_SKIP_SEQ_TEST )
         ...
         add_test(NAME ${FEELPP_TEST_EXEC}-np-1 COMMAND ${CMAKE_CURRENT_BINARY_DIR}/${targetname} --log_level=all ${BOOST_TEST_SEPARATOR} ${FEELPP_TEST_CFG_CLI} ${FEELPP_TEST_CLI} --directory=testsuite/test_${FEELPP_TEST_NAME}  --rm )
      endif()
