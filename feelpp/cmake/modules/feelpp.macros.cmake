...
macro(feelpp_add_test)
  ...
  if ( FEELPP_TEST_NO_FEELPP_LIBRARY )
    feelpp_add_application( ${FEELPP_TEST_NAME} SRCS ${_SRCS_FILE} CFG  ${FEELPP_TEST_CFG} PYTHON ${FEELPP_TEST_PYTHON} GEO ${FEELPP_TEST_GEO} MESH ${FEELPP_TEST_MESH}  DEFS ${FEELPP_TEST_DEFS} PROJECT ${FEELPP_TEST_PROJECT} EXEC targetname LINK_LIBRARIES  ${FEELPP_TEST_LINK_LIBRARIES} NO_TEST NO_FEELPP_LIBRARY )
  else()
    feelpp_add_application( ${FEELPP_TEST_NAME} SRCS ${_SRCS_FILE} CFG  ${FEELPP_TEST_CFG} PYTHON ${FEELPP_TEST_PYTHON} GEO ${FEELPP_TEST_GEO}  MESH ${FEELPP_TEST_MESH} DEFS ${FEELPP_TEST_DEFS}  PROJECT ${FEELPP_TEST_PROJECT} EXEC targetname LINK_LIBRARIES ${FEELPP_TEST_LINK_LIBRARIES} NO_TEST )
  endif()
