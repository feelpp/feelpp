...
public:
  ...
  public:
    ...
    /**
     * Lazily register and parse options owned by an instantiated component.
     *
     * Re-registering the same complete option description is idempotent.
     * Partial overlap is rejected because it usually indicates inconsistent
     * component prefixes or option definitions.
     *
     * @param desc component-specific option description
     */
    static void addOptions( po::options_description const& desc );
