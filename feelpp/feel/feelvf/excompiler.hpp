...
#ifndef FEEL_GINAC_EXCOMPILER_H
#define FEEL_GINAC_EXCOMPILER_H
...
/**
 * @brief cleanup all generated files
 *
 * @param verbose true if you want to print the files that are being removed
 */
