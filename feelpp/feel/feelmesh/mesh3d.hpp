...
{
    // check at compilation time that the shape has indeed dimension 3
    static_assert( Shape::nDim == 3, "Mesh3D requires a 3D shape" );

  public:
    static constexpr uint16_type nDim = 3;
    static constexpr uint16_type nRealDim = 3;
