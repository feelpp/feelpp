 ...
 */
template<typename Geo, int Dim = 1, int Order = 1, int RDim = Dim, typename T = double>
class Reference
{};
...
template<typename Geo, int Dim, int Order, int RDim, typename T>
std::ostream&
...
template <int Dim, int Order, int RDim, typename T> struct is_reference_convex<Reference<Simplex<Dim,Order,RDim>,Dim,Order,RDim,T>>: std::true_type {};
template <int Dim, int Order, int RDim, typename T> struct is_reference_convex<Reference<Hypercube<Dim,Order,RDim>,Dim,Order,RDim,T>>: std::true_type {};
/**
