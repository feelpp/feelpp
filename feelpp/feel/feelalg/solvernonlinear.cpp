...
SolverNonLinear<T,SizeT>::SolverNonLinear ( std::string const& prefix, worldcomm_ptr_t const& worldComm, po::variables_map const& vm )
    ...
    M_kspRestartGMRES( ioption(_name="gmres-restart", _prefix=prefix, _vm=vm ) ),
    M_kspRestartFGMRES( ioption(_name="fgmres-restart", _prefix=prefix, _vm=vm ) ),
    M_kspRestartGCR( ioption(_name="gcr-restart", _prefix=prefix, _vm=vm ) ),
...
SolverNonLinear<T,SizeT>::SolverNonLinear ( SolverNonLinear const& snl )
    ...
    M_kspUseInitialGuessNonZero( snl.M_kspUseInitialGuessNonZero ),
