...
journal_options( std::string const& prefix )
{
    ...
    options.add_options()
        ...
        ( prefixvm( prefix,"journal.auto.pullatdelete" ).c_str(), Feel::po::value<bool>()->default_value(false), "Watchers send their information before dying." )
        ( prefixvm( prefix,"journal.auto.mesh" ).c_str(), Feel::po::value<bool>()->default_value(true), "Enable mesh info" )
        ( prefixvm( prefix,"journal.auto.functionspace" ).c_str(), Feel::po::value<bool>()->default_value(true), "Enable function space info" )
        ( prefixvm( prefix,"journal.auto.timer" ).c_str(), Feel::po::value<bool>()->default_value(true), "Enable timer stats" )
        ( prefixvm( prefix,"journal.auto.hwsys" ).c_str(), Feel::po::value<bool>()->default_value(true), "Enable hardware info" )
