...
* Download resource from CKAN

[source,shell]
----
feelpp_remotedata --download "ckan:{url:https://ckan.example.com,resource:resource-id}"
----
...
* Upload file/resource to CKAN (require an API key)

[source,shell]
----
feelpp_remotedata --upload "ckan:{url:https://ckan.example.com,dataset:dataset-id,api_key:your-api-key}" --data $HOME/mydata
----
...
[source,shell]
----
feelpp_remotedata --contents "ckan:{url:https://ckan.example.com,dataset:dataset-id}"
feelpp_remotedata --contents "ckan:{url:https://ckan.example.com,dataset:dataset-id,api_key:your-api-key}"
----
