...
./configure  --prefix=$prefix\
    ...
    --with-mpi-lib=[/bgsys/drivers/V1R2M1/ppc64/comm/lib/libmpich-gcc.so,/bgsys/drivers/V1R2M1/ppc64/comm/lib/libopa-gcc.so,/bgsys/drivers/V1R2M1/ppc64/comm/lib/libmpl-gcc.so,/bgsys/drivers/V1R2M1/ppc64/comm/lib/libpami-gcc.so,/bgsys/drivers/V1R2M1/ppc64/spi/lib/libSPI.a,/bgsys/drivers/V1R2M1/ppc64/spi/lib/libSPI_cnk.a] \
    --download-mumps=0 \
    --download-pastix=0 \
    --download-ptscotch=1 \
    --download-scalapack=1 \
    --download-ml=0 \
    --download-superlu=1 --CC=$CC --FC=$FC
