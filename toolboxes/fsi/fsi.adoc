...
{manmanual} - fluid structure interaction toolbox application
...
{manmanual} is an application which can run fluid structure interaction model defined by a sest of files : a geometry or mesh, a config file(`.cfg`) and  a model file(`.json`)
