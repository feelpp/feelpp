...
feelpp_toolbox_thermoelectric --case <directory to model case> [--case.dim 3] [--case.discretization P1] 
...
We are now using the `feelpp/feelpp-toolboxes:latest` docker images as described in link:http://docs.feelpp.org/user/0.107/install/containers/#_docker[] to demonstrate feelpp_toolbox_thermoelectric usage.
...
Other test cases can be found in /usr/share/feelpp/data/testcases/toolboxes/thermoelectric.
...
http://docs.feelpp.org/cases/0.107/thermoelectric/README

{feelpp} Toolbox Docs for feelpp_toolbox_thermoelectric::
http://docs.feelpp.org/toolboxes/0.107/thermoelectric/
