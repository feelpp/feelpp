model test3d0d_nonlinearR
  ...
  parameter Real M_alpha0 = 0.0; // -3/(8*pi*pi);
  parameter Real M_alpha1 = 0.0; // 2.0;
  parameter Real M_alpha2 = 0.0; // 0.1;
  ...
  voltage_nonlinearTest3d0d Pi_out(gamma=M_gamma, C1 = M_C1, Cb = M_Cb, R1bar = M_R1, Rb = M_Rb, Rout = M_Rout, alpha = M_alpha, alpha0 = M_alpha0, alpha1 = M_alpha1, alpha2 = M_alpha2, beta = M_beta) annotation(
  ...
  Modelica.Electrical.Analog.Basic.Capacitor C(C = M_C1, v(fixed = true, start = 8.2))  annotation(
