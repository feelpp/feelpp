class nonlinearResistor "Ractual = Rbar + alpha0/(1 + alpha1*Modelica.Math.exp(-alpha2*Vinput)))"
  ...
  parameter Real alpha0 "alpha0 non-linear coefficient";
  parameter Real alpha1 "alpha1 non-linear coefficient";
  parameter Real alpha2 "alpha2 non-linear coefficient";
