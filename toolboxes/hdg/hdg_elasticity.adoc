...
{manmanual} - hybridized discontinuous Galerkin elasticity toolbox application
...
{manmanual} is an application which can run hybridized discontinuous Galerkin elasticity model defined by a sest of files : a geometry or mesh, a config file(`.cfg`) and  a model file(`.json`)
