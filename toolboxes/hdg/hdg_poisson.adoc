...
----
feelpp_toolbox_hdg_poisson --case <directory to model case> [--case.dim 3] [--case.discretization ] [--hdg_poisson.ksp-monitor=<0,1>] [--hdg_poisson.ksp-view=<0,1>] [--hdg_poisson.ksp-type=<see below>] [--hdg_poisson.pc-view=<0,1>] [--hdg_poisson.pc-type=<see below>] [--hdg_poisson.snes-monitor=<0,1>] [--hdg_poisson.ksp-type=<see below>]
----
