class voltageInterfaceSource
  ...
  parameter Modelica.SIunits.Capacitance Rb;
 
  
equation
   
  v = beta + alpha*Modelica.Math.sin(gamma*time)+(1-Rb)*Cb*alpha*gamma*Modelica.Math.cos(gamma*time);
