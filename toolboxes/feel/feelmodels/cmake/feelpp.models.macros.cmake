...
macro( genLibElectric )
  PARSE_ARGUMENTS(FEELMODELS_APP
    "DIM;P_FE_BASIS_TYPE;P_FE_BASIS_TAG;GEO_ORDER;"
    ""
    ${ARGN}
    )
  ...
  set(ELECTRIC_FE_BASIS_TYPE ${FEELMODELS_APP_P_FE_BASIS_TYPE})
  set(ELECTRIC_FE_BASIS_TAG ${FEELMODELS_APP_P_FE_BASIS_TAG})

  set(ELECTRIC_LIB_VARIANTS ${ELECTRIC_DIM}d${ELECTRIC_FE_BASIS_TAG}G${ELECTRIC_ORDERGEO} )
...
macro( genLibThermoElectric )
  PARSE_ARGUMENTS(FEELMODELS_APP
    "DIM;T_ORDER;ELECTRIC_P_FE_BASIS_TYPE;ELECTRIC_P_FE_BASIS_TAG;GEO_ORDER;"
    ""
    ${ARGN}
  )

  if ( NOT ( FEELMODELS_APP_DIM OR FEELMODELS_APP_T_ORDER OR
        FEELMODELS_APP_ELECTRIC_P_FE_BASIS_TYPE OR FEELMODELS_APP_ELECTRIC_P_FE_BASIS_TAG OR
        FEELMODELS_APP_GEO_ORDER ) )
    message(FATAL_ERROR "miss argument in genLibThermoElectric!")
  endif()

  set(THERMOELECTRIC_DIM ${FEELMODELS_APP_DIM})
  set(THERMOELECTRIC_T_ORDER ${FEELMODELS_APP_T_ORDER})
  set(THERMOELECTRIC_ELECTRIC_P_FE_BASIS_TYPE ${FEELMODELS_APP_ELECTRIC_P_FE_BASIS_TYPE})
  set(THERMOELECTRIC_ELECTRIC_P_FE_BASIS_TAG ${FEELMODELS_APP_ELECTRIC_P_FE_BASIS_TAG})
  ...
  genLibElectric(
    DIM     ${THERMOELECTRIC_DIM}
    P_FE_BASIS_TYPE ${THERMOELECTRIC_ELECTRIC_P_FE_BASIS_TYPE}
    P_FE_BASIS_TAG ${THERMOELECTRIC_ELECTRIC_P_FE_BASIS_TAG}
    GEO_ORDER ${THERMOELECTRIC_ORDERGEO}
  )
...
macro( genLibElectromagnetic )
  ...
  genLibElectric(
    ...
    P_FE_BASIS_TYPE ${ELECTROMAGNETIC_ELECTRIC_P_FE_BASIS_TYPE}
    P_FE_BASIS_TAG ${ELECTROMAGNETIC_ELECTRIC_P_FE_BASIS_TAG}
