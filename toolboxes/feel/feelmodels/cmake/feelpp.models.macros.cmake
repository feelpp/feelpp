...
macro( genLibMaxwellH1 )
  ...
  set(MAXWELLH1_LIB_VARIANTS ${MAXWELL_DIM}dP${MAXWELL_ORDERPOLY}G${MAXWELL_ORDERGEO}H1 )
  set(MAXWELLH1_LIB_NAME feelpp_toolbox_maxwell_h1_lib_${MAXWELLH1_LIB_VARIANTS})

  if ( NOT TARGET ${MAXWELLH1_LIB_NAME} )
    # configure the lib
    set(MAXWELLH1_LIB_DIR ${FEELPP_TOOLBOXES_BINARY_DIR}/feel/feelmodels/maxwell/${MAXWELLH1_LIB_VARIANTS})
    set(MAXWELLH1_CODEGEN_FILES_TO_COPY
      ${FEELPP_TOOLBOXES_SOURCE_DIR}/feel/feelmodels/maxwell/maxwell_inst.cpp )
    set(MAXWELLH1_CODEGEN_SOURCES
      ${MAXWELLH1_LIB_DIR}/maxwell_inst.cpp )
    set(MAXWELLH1_LIB_DEPENDS feelpp_modelalg feelpp_modelmesh feelpp_modelcore )
    # generate the lib target
    genLibBase(
      LIB_NAME ${MAXWELLH1_LIB_NAME}
      LIB_DIR ${MAXWELLH1_LIB_DIR}
      LIB_DEPENDS ${MAXWELLH1_LIB_DEPENDS}
      FILES_TO_COPY ${MAXWELLH1_CODEGEN_FILES_TO_COPY}
      FILES_SOURCES ${MAXWELLH1_CODEGEN_SOURCES}
      CONFIG_PATH ${FEELPP_TOOLBOXES_SOURCE_DIR}/feel/feelmodels/maxwell/maxwellconfig.h.in
      )
  endif()
endmacro(genLibMaxwell)
