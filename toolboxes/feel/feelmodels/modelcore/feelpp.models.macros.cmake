...
macro( genLibLevelset )
  ...
  set(ADVECTION_LIB_NAME ${ADVECTION_LIB_NAME})
  ...
  set(ADVECTIONVEC_LIB_NAME ${ADVECTION_LIB_NAME})
  #######################################################
  ...
  if ( NOT TARGET ${LEVELSET_LIB_NAME} )
    ...
    set(LEVELSET_LIB_DEPENDS ${ADVECTION_LIB_NAME} ${ADVECTIONVEC_LIB_NAME} ${FEELPP_LIBRARIES} )
    # generate the lib target
    genLibBase(
