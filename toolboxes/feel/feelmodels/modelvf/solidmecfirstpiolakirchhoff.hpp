...
private :
    ...
    struct tensorFirstPiolaKirchhoffBase : public tensorBase<Geo_t,Basis_i_t,Basis_j_t,typename ExprType::shape_type,typename ExprType::value_type >
    {
        ...
        typedef typename fe_displacement_type::template Context<expr_type::context_displacement, fe_displacement_type, gm_type,geoelement_type> ctx_displacement_type;
