...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim,Order, G_Order, E_Order>::createTimeDiscretization()
{
	...
	{ 
    	...
    	M_bdf_buffer[i]->setPathSave( (fs::path(this->rootRepository()) /
                               fs::path( prefixvm(this->prefix(), (boost::format("bdfY_o_%1%_dt_%2%")%M_bdf_buffer[i]->bdfOrder()%this->timeStep() ).str() ) ) ).string() );
	}
...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim, Order, G_Order, E_Order>::initModel(){
...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim, Order, G_Order, E_Order>::initSpaces(){
...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim, Order, G_Order, E_Order>::assembleCstPart( ) 
{
...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim, Order, G_Order, E_Order>::assembleNonCstPart( ) 
{
...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim, Order, G_Order, E_Order>::assemble0d( int i ) 
{
...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim, Order, G_Order, E_Order>::assembleRhs0d( int i )
{
...
template <int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim,Order, G_Order, E_Order>::exportResults( double time, mesh_ptrtype mesh, op_interp_ptrtype Idh, opv_interp_ptrtype Idhv)
{
...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim, Order, G_Order, E_Order>::solve()
{  
...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim, Order, G_Order, E_Order>::second_step(double final_time, int i)
{
    tic();
...
template<int Dim, int Order, int G_Order, int E_Order>
void
CoupledMixedPoisson<Dim, Order, G_Order, E_Order>::run( op_interp_ptrtype Idh_poi, opv_interp_ptrtype Idhv_poi)
{
