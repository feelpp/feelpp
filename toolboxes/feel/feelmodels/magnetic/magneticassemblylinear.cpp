...
void
MAGNETIC_CLASS_TEMPLATE_TYPE::updateLinearPDE( DataUpdateLinear & data ) const
{
...
MAGNETIC_CLASS_TEMPLATE_DECLARATIONS
void
MAGNETIC_CLASS_TEMPLATE_TYPE::updateLinearPDEDofElimination( DataUpdateLinear & data ) const
{
