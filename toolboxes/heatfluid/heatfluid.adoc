...
{manmanual} - heat and fluid toolbox application
...
{manmanual} is an application which can run heat and fluid model defined by a sest of files : a geometry or mesh, a config file(`.cfg`) and  a model file(`.json`)
