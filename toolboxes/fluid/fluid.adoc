...
feelpp_toolbox_fluid --case <directory to model case> [--case.dim 3] [--case.discretization P2P1G1] 
...
We are now using the `feelpp/feelpp-toolboxes:latest` docker images as described in link:http://docs.feelpp.org/user/0.107/install/containers/#_docker[] to demonstrate feelpp_toolbox_fluid usage.
...
Other test cases can be found in /usr/share/feelpp/data/testcases/toolboxes/fluid.
...
http://docs.feelpp.org/cases/0.107/cfd/README

{feelpp} Toolbox Docs for feelpp_toolbox_fluid::
http://docs.feelpp.org/toolboxes/0.107/cfd/
