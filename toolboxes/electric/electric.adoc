...
{manmanual} - electric toolbox application
...
{manmanual} is an application which can run electric model defined by a sest of files : a geometry or mesh, a config file(`.cfg`) and  a model file(`.json`)
