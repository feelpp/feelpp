...
----
feelpp_toolbox_electric --case <directory to model case> [--case.dim 3] [--case.discretization P1] [--electric.ksp-monitor=<0,1>] [--electric.ksp-view=<0,1>] [--electric.ksp-type=<see below>] [--electric.pc-view=<0,1>] [--electric.pc-type=<see below>] [--electric.snes-monitor=<0,1>] [--electric.ksp-type=<see below>]
----
